...
};break;case"lcd":d=["Wire.h","BitbloqLiquidCrystal.h"],c={name:a.components[h].name,type:"LiquidCrystal",arguments:["0"]},b=a.components[h].name+".begin(16, 2);"+a.components[h].name+".clear();";break;case"RGBled":d=["BitbloqRGB.h"],c={name:a.components[h].name,type:"ZumRGB",arguments:[a.components[h].pin.r,a.components[h].pin.g,a.components[h].pin.b]};break;case"rtc":d=["Wire.h","BitbloqRTC.h"],c={name:a.components[h].name,type:"RTC_DS1307"};break;case"hts221":d=["Wire.h","BitbloqHTS221.h","HTS221_Registers.h"],c={name:a.components[h].name,type:"HTS221"},b="Wire.begin();\n"+a.components[h].name+".begin();";break;case"us":d=["BitbloqUS.h"],c={name:a.components[h].name,type:"US",arguments:[a.components[h].pin.trigger,a.components[h].pin.echo]};break;case"servo":case"servocont":a.components[h].oscillator&&"false"!==a.components[h].oscillator?(d=["Servo.h","Wire.h","BitbloqOscillator.h"],c={name:a.components[h].name,type:"Oscillator"}):(d=["Servo.h"],c={name:a.components[h].name,type:"Servo"}),b=a.components[h].name+".attach("+a.components[h].pin.s+");";break;case"irs2":d=["BitbloqLineFollower.h"],c={name:a.components[h].name,type:"LineFollower",arguments:[a.components[h].pin.s1,a.components[h].pin.s2]};break;case"mkb_ultrasound":d=["BitbloqUS.h"],c={name:a.components[h].name,type:"BitbloqUltrasound",arguments:[g+"::ports["+a.components[h].pin.s+"][2]",g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();"]=!0;break;case"mkb_linefollower":c={name:a.components[h].name+"_1",type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][1]"},b="pinMode("+a.components[h].name+"_1 , INPUT);",o(c,{},a),x[b]=!0,c={name:a.components[h].name+"_2",type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+"_2 , INPUT);";break;case"mkb_lightsensor":b="pinMode("+a.components[h].name+", INPUT);",c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"};break;case"mkb_joystick":d=["BitbloqJoystick.h"];var i,j=2;for(i=0;j>i;i++)c={name:a.components[h].name+"_"+(i+1),type:"const int",equals:g+"::ports["+a.components[h].pin.s+"]["+(i+1)+"]"},b="pinMode("+a.components[h].name+"_"+(i+1)+" , INPUT);",o(c,{},a),x[b]=!0;c={name:a.components[h].name,type:"Joystick",arguments:[a.components[h].name+"_1",a.components[h].name+"_2",0]};break;case"mkb_soundsensor":c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+", INPUT);",o(c,{},a),x[b]=!0;break;case"mkb_pot":c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+", INPUT);",o(c,{},a),x[b]=!0;break;case"mkb_4buttonKeyPad":d=["BitbloqButtonPad.h"],c={name:a.components[h].name,type:"BitbloqMe4ButtonPad",arguments:[g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();"]=!0;break;case"mkb_ledmatrix":d=["BitbloqMeLEDMatrix.h"],c={name:a.components[h].name,type:"BitbloqMeLEDMatrix",arguments:[g+"::ports["+a.components[h].pin.s+"][1]",g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();\n"+a.components[h].name+".setBrightness(6);\n"+a.components[h].name+".setColorIndex(1);"]=!0;break;case"mkb_display7seg":d=["Bitbloq7SegmentDisplay.h"],c={name:a.components[h].name,type:"Bitbloq7SegmentDisplay",arguments:[g+"::ports["+a.components[h].pin.s+"][1]",g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();"]=!0;break;case"mkb_remote":d=["IRremoteInt.h","IRremote.h","BitbloqIRControl.h"],c={name:a.board,type:g},y[a.board+".setup();"]=!0;break;case"mkb_motionSensor":c={name:a.components[h].name+"_mode",type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][1]"},b="pinMode("+a.components[h].name+"_mode , OUTPUT);",o(c,{},a),x[b]=!0,c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+" , INPUT);",o(c,{},a),x[b]=!0,b="digitalWrite("+a.components[h].name+"_mode , 0);",o(c,{},a),x[b]=!0}c&&o(c,{},a),b&&(x[b]=!0),e&&(z[e]=!0),f&&(A[f]=!0);for(var k=0;k<d.length;k++)v[d[k]]=!0}}function o(a,b,c){var d=a.name;if(d=k(d,b,c),a.arguments){for(var e=0;e<a.arguments.length;e++)a.arguments[e]=k(a.arguments[e],b,c);if(a.arguments.indexOf("undefined")>-1){for(var f=_.clone(a.arguments),g=0;g<f.length;g++)"undefined"===f[g]&&(f[g]=String(g));var h=d+String(f||"")}}var i=d+String(a.arguments||"");h&&w[h]||(w[i]={equals:k(a.equals,b,c),type:a.type,name:a.name,realName:d,arguments:a.arguments})}var p,q=/{([^{].[^(\s]*?)}/,r=/º\[([^{].*?)\.(.*?)\]/,s=/@{([^{].*?)\.(.*?)}/,t=/¬{([^{].*?)\.(.*?)}/,u=/\${CLASS-OUTSIDE}/,v={},w={},x={},y={},z={},A={},B={withoutAsterisk:function(a){return a.replace("*","")},formatPin:function(a){return-1!==a.indexOf("A")&&(a=a.replace(/\"/g,"")),a},readPin:function(a){var b;return b=-1!==a.indexOf("A")?"analogRead("+a+")":"digitalRead("+a+")"},getHashCodeFromString:function(a){return a.replace("{","").replace("}","").replace(/ /g,"").replace(/0x/g,"").replace(/,/g,"")},readSensor:function(a,b,c){for(var d,e,f=0;!e&&f<c.components.length;)c.components[f].name===a&&(e=c.components[f]),f++;if(e)switch(e.type){case"analog":d="analogRead("+a+")";break;case"digital":d="digitalRead("+a+")";break;case"LineFollower":d="(float *) "+a+".read()";break;case"mkb_linefollower":d="digitalRead("+a+"_1) + digitalRead("+a+"_2) * 2";break;case"mkb_integrated_analogPinButton":d="robot.isButtonPushed()";break;case"mkb_integrated_lightsensor":var g=e.pin.s||"";d="robot.readLightSensor("+g+")";break;case"remote":d=c.board+".getInfraredControlCommand()";break;default:d=a+".read()"}return d||""}};return a.getCode=b,a}(window.arduinoGeneration=window.arduinoGeneration||{},void 0),function(a,b,c){function d(a,b){v=a||v,u=b||u}function e(a){u?(a=a||{},a.workspaceWidth=a.workspaceWidth||0,a.workspaceHeight=a.workspaceHeight||0,a.launcherTopPoint=a.launcherTopPoint||0,a.launcherBottomPoint=a.launcherBottomPoint||0,a.suggestedBloqs=a.suggestedBloqs||[],a.suggestedText=a.suggestedText||"",a.fieldOffsetTop=a.fieldOffsetTop||0,a.fieldOffsetLeft=a.fieldOffsetLeft||0,a.fieldOffsetRight=a.fieldOffsetRight||0,a.fieldScrollTop=a.fieldScrollTop||0,a.fieldScrollLeft=a.fieldScrollLeft||0,x=a.showWindowCallback,console.log("params.suggestedBloqs",a.suggestedBloqs),f(),a.suggestedText&&i(a.suggestedText),h({launcherTopPoint:a.launcherTopPoint,launcherHeight:a.launcherHeight,launcherBottomPoint:a.launcherBottomPoint,suggestedWindowWidth:q.offsetWidth,suggestedWindowHeight:q.offsetHeight,workspaceHeight:a.workspaceHeight,workspaceWidth:a.workspaceWidth,fieldOffsetTop:a.fieldOffsetTop,fieldOffsetLeft:a.fieldOffsetLeft,fieldOffsetRight:a.fieldOffsetRight,fieldScrollTop:a.fieldScrollTop,fieldScrollLeft:a.fieldScrollLeft}),a.suggestedBloqs&&a.suggestedBloqs.length>0?m(a.suggestedBloqs):(j(a.noSuggestedText),console.log("no bloqs suggested"))):console.error("You must set the bloqSchemas")}function f(){if(q)q.className=q.className.replace("hide","");else{r=k(),q=document.createElement("div"),q.className="suggestion-window",t=document.createElement("div"),t.className="bloqs-container";var a=document.createElement("div");a.className+="triangle top";var b=document.createElement("div");b.className+="triangle bottom",q.appendChild(a),q.appendChild(r),q.appendChild(t),q.appendChild(b),v.appendChild(q)}return w=[],document.addEventListener("mousedown",l),document.addEventListener("touchstart",l),window.addEventListener("bloqs:mousedown",l),window.addEventListener("bloqs:dragend",n),q}function g(){-1===q.className.indexOf("hide")&&(q.className+=" hide"),document.removeEventListener("mousedown",l),document.removeEventListener("touchstart",l),window.removeEventListener("bloqs:mousedown",l),window.removeEventListener("bloqs:dragend",n)}function h(a){console.log("place window in the available space",a),q.className=q.className.replace(" right",""),q.className=q.className.replace(" top","");var b=6,c=21,d={},e=a.workspaceHeight+a.fieldOffsetTop-a.launcherBottomPoint.top,f=a.launcherTopPoint.top-a.fieldOffsetTop,g=a.suggestedWindowHeight+b,h=a.workspaceWidth-a.fieldOffsetRight-(a.launcherBottomPoint.left-a.fieldOffsetLeft),i=a.launcherBottomPoint.left-a.fieldOffsetLeft,j=a.suggestedWindowWidth+c;e>=g||e>=f||g>f?d.top=a.launcherBottomPoint.top-a.fieldOffsetTop+b+a.fieldScrollTop:(d.top=a.launcherTopPoint.top-a.fieldOffsetTop-a.suggestedWindowHeight-b+a.fieldScrollTop,q.className+=" top"),h>=j||h>=i||j>i?d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-c+a.fieldScrollLeft:(d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-a.suggestedWindowHeight+c+a.fieldScrollLeft,q.className+=" left"),q.style.transform="translate("+d.left+"px,"+d.top+"px)"}function i(a){s&&(s.innerHTML=a)}function j(a){var b=document.createElement("p");b.innerHTML=a,t&&t.appendChild(b)}function k(){s=document.createElement("h3");var a=document.createElement("div");return a.className+="sugg-header",a.appendChild(s),a}function l(a){console.log("actionWithWindowOpenListener",a);var b;b=1!==a.detail?a.detail:a.target,c.findAncestor(b,"suggestion-window")||p()}function m(a){for(var b,c,d=0;d<a.length;d++)b=new bloqs.Bloq({bloqData:u[a[d]]}),w.push(b),c=document.createElement("div"),c.className+="bloq-container",c.appendChild(b.$bloq[0]),t.appendChild(c),b.$bloq[0].addEventListener("click",o)}function n(a){console.log("onSuggestedBloqDragEnd",a.detail.bloq),p(a.detail.bloq.uuid)}function o(a){console.log("onSuggestedBloqClick",a);var b=a.currentTarget,c=b.getAttribute("data-bloq-id");p(c,!0)}function p(a,b){for(var c=0;c<w.length;c++)w[c].$bloq[0].removeEventListener("click",o),w[c].uuid!==a&&w[c].autoRemove();t.innerHTML="",a&&b&&x(a),g()}var q,r,s,t,u,v,w,x;return a.init=d,a.showSuggestedWindow=e,a.setSuggestedText=i,a}(window.bloqsSuggested=window.bloqsSuggested||{},bloqsLanguages,bloqsUtils,void 0),function(a,b,c){function d(a,b){s=a||s}function e(a){a=a||{},a.workspaceWidth=a.workspaceWidth||0,a.workspaceHeight=a.workspaceHeight||0,a.launcherTopPoint=a.launcherTopPoint||0,a.launcherBottomPoint=a.launcherBottomPoint||0,a.fieldOffsetTop=a.fieldOffsetTop||0,a.fieldOffsetLeft=a.fieldOffsetLeft||0,a.fieldOffsetRight=a.fieldOffsetRight||0,a.fieldScrollTop=a.fieldScrollTop||0,a.fieldScrollLeft=a.fieldScrollLeft||0,t=a.showWindowCallback,l(a),h(a.dotsMatrixOptions.value,a.dotsMatrixOptions.options),p({launcherTopPoint:a.launcherTopPoint,launcherHeight:a.launcherHeight,launcherBottomPoint:a.launcherBottomPoint,bloqsWindowWidth:q.offsetWidth,bloqsWindowHeight:q.offsetHeight,workspaceHeight:a.workspaceHeight,workspaceWidth:a.workspaceWidth,fieldOffsetTop:a.fieldOffsetTop,fieldOffsetLeft:a.fieldOffsetLeft,fieldOffsetRight:a.fieldOffsetRight,fieldScrollTop:a.fieldScrollTop,fieldScrollLeft:a.fieldScrollLeft})}function f(a){console.log(a.dotsMatrixOptions);for(var b,c,d=0;d<a.dotsMatrixOptions.options.rows;d++){b=document.createElement("div"),b.className+="bloqs-dots-row",v[d]=[];for(var e=0;e<a.dotsMatrixOptions.options.columns;e++)c=document.createElement("div"),c.className+="bloqs-dots-dot",v[d].push(c),v[d][e].addEventListener("mouseover",k),b.appendChild(c);r.appendChild(b)}}function g(a,b,d){for(var e=c.createMatrix(b,d),f=a.replace("{","").replace("}","").replace(/ /g,"").replace(/0x/g,"").split(","),g=0;g<f.length;g++)f[g]=parseInt(f[g],16).toString(2),f[g]=f[g].split("").reverse().join("");console.log(f[g]);for(var h=0;h<f.length;h++)for(var i=0;b>i;i++)"1"===f[h].charAt(i)?e[b-1-i][h]=!0:e[b-1-i][h]=!1;return e}function h(a,b){console.log("setMatrix",a),a=a?g(a,b.rows,b.columns):c.createMatrix(b.rows,b.columns);for(var d=0;d<v.length;d++)for(var e=0;e<v[d].length;e++)a[d][e]?-1===v[d][e].className.indexOf("active")&&(v[d][e].className+=" active"):v[d][e].className=v[d][e].className.replace("active","")}function i(){for(var a=[],b=[],c=0;c<v[0].length;c++)b[c]="";for(var d=0;d<v.length;d++){a[d]=[];for(var e=0;e<v[d].length;e++)a[d][e]=-1!==v[d][e].className.indexOf("active"),a[d][e]?b[e]+="1":b[e]+="0"}for(var f=0;f<b.length;f++)b[f]="0x"+parseInt(b[f],2).toString(16);return console.log(b),b=b.toString(),console.log(b),b}function j(a){var b=a.target;-1===b.className.indexOf("active")?b.className+=" active":b.className=b.className.replace("active",""),i()}function k(a){if(console.log("over"),w){var b=a.target;-1===b.className.indexOf("active")&&(b.className+=" active")}}function l(a){if(q)o();else{q=document.createElement("div"),q.className="dotsMatrix-window",r=document.createElement("div"),r.className="dots-container";var b=document.createElement("div");b.className+="triangle top";var c=document.createElement("div");c.className+="triangle bottom",f(a),q.addEventListener("mousedown",function(a){q.addEventListener("mouseup",function(){w=!1}),w=!0,j(a),console.log("activating")}),q.addEventListener("mouseleave",function(){w=!1,m()}),q.appendChild(b),q.appendChild(r),q.appendChild(c),s.appendChild(q)}return q}function m(){u||(q.addEventListener("mouseover",n),-1===q.className.indexOf("opacity0")&&(q.className+=" opacity0"),u=setTimeout(function(){u=null,-1===q.className.indexOf("hide")&&(q.className+=" hide"),q.removeEventListener("mouseover",n),t(i())},500))}function n(){q.removeEventListener("mouseover",n),console.log("mouseover cancel hide"),o(),clearTimeout(u),u=null}function o(){q.className=q.className.replace("opacity0","").replace("hide","")}function p(a){console.log("place window in the available space",a),q.className=q.className.replace(" right",""),q.className=q.className.replace(" top","");var b=0,c=31,d={},e=a.workspaceHeight+a.fieldOffsetTop-a.launcherBottomPoint.top,f=a.launcherTopPoint.top-a.fieldOffsetTop,g=a.bloqsWindowHeight+b,h=a.workspaceWidth-a.fieldOffsetRight-(a.launcherBottomPoint.left-a.fieldOffsetLeft),i=a.launcherBottomPoint.left-a.fieldOffsetLeft,j=a.bloqsWindowWidth+c;e>=g||e>=f||g>f?d.top=a.launcherBottomPoint.top-a.fieldOffsetTop+b+a.fieldScrollTop:(d.top=a.launcherTopPoint.top-a.fieldOffsetTop-a.bloqsWindowHeight-b+a.fieldScrollTop,q.className+=" top"),h>=j||h>=i||j>i?d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-c+a.fieldScrollLeft:(d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-a.bloqsWindowHeight+c+a.fieldScrollLeft,q.className+=" left"),q.style.transform="translate("+d.left+"px,"+d.top+"px)"}var q,r,s,t,u,v=[],w=!1;return a.init=d,a.showDotsWindow=e,a}(window.bloqsDotsMatrix=window.bloqsDotsMatrix||{},bloqsLanguages,bloqsUtils,void 0),function(a,b,c,d,e,f,g,h){function i(a,b,c,d){for(var e,f=0;f<a[b].length;f++)e=a[b][f],e.type=x.getTypeFromBloq(c[e.bloqUuid],c,d,a,P)}function j(a,b){var c=b.target.getBoundingClientRect(),d=E[0].getBoundingClientRect(),e={launcherTopPoint:{top:c.top,left:c.left},launcherBottomPoint:{top:c.bottom,left:c.left},launcherHeight:c.height,workspaceHeight:d.height,workspaceWidth:d.width,fieldOffsetTop:R(K),fieldOffsetLeft:I,fieldOffsetRight:J,fieldScrollTop:E[0].scrollTop,fieldScrollLeft:E[0].scrollLeft,dotsMatrixOptions:a};e.showWindowCallback=function(b){a.value=b},h.showDotsWindow(e)}function k(a){if(console.log("click input",a),a.target.hasAttribute("data-connector-name")){var b=a.target.getAttribute("data-connector-id");console.log("id",b);var c=x.getBloqByConnectorUuid(b,B,A);if(console.log(c.itsEnabled()),c.itsEnabled()){a.stopPropagation();var d=a.target.getBoundingClientRect(),e=E[0].getBoundingClientRect(),f={suggestedText:xa(y,"suggested"),noSuggestedText:xa(y,"no-suggested"),launcherTopPoint:{top:d.top,left:d.left},launcherBottomPoint:{top:d.bottom,left:d.left},launcherHeight:d.height,workspaceHeight:e.height,workspaceWidth:e.width,fieldOffsetTop:R(K),fieldOffsetLeft:I,fieldOffsetRight:J,fieldScrollTop:E[0].scrollTop,fieldScrollLeft:E[0].scrollLeft,availableBloqs:s};A[b]?f.suggestedBloqs=A[b].data.suggestedBloqs:z[b]&&(f.suggestedBloqs=z[b].data.suggestedBloqs),f.suggestedBloqs=l(f.suggestedBloqs,P,H,f.availableBloqs),f.showWindowCallback=function(a){var d=B[a];d.isConnectable()||d.doConnectable(),X(d,A[b].jqueryObject),window.dispatchEvent(new CustomEvent("bloqs:suggestedAdded",{detail:c}))},g.showSuggestedWindow(f)}}}function l(a,b,c,d){for(var e=[],f=0;f<a.length;f++)if(!d||d&&d.indexOf(a[f])>-1)switch(a[f]){case"selectVariable":c.softwareVars.length>0&&e.push(a[f]);break;case"readSensor":b.sensors.length>0&&e.push(a[f]);break;default:e.push(a[f])}return e}function m(a){-1===a.target.parentElement.parentElement.className.indexOf(" collapsed")?(a.target.parentElement.parentElement.className=a.target.parentElement.parentElement.className.concat(" collapsed"),a.target.innerHTML="+"):(a.target.parentElement.parentElement.className=a.target.parentElement.parentElement.className.replace(" collapsed",""),a.target.innerHTML="-")}var n,o,p,q,r,s,t,u,v,w,x=d,y="es-ES",z={},A={},B={},C=[],D=[],E=null,F=0,G=null,H={voidFunctions:[],returnFunctions:[],softwareVars:[],classes:[],objects:[]},I=0,J=0,K=[],L=0,M=null,N=null,O=null,P=d.getEmptyComponentsArray(),Q=function(a){K=a.fieldOffsetTopSource||K||[],I=a.fieldOffsetLeft||I||0,J=a.fieldOffsetRight||J||0,L=a.fieldOffsetTopForced||L||0,s=a.availableBloqs,(0===a.forcedScrollTop||a.forcedScrollTop)&&(G=a.forcedScrollTop),g.init(a.suggestionWindowParent,a.bloqSchemas),h.init(a.dotsMatrixWindowParent),y=a.lang||"es-ES"},R=function(a){var b=0;if(L)b=L;else for(var c,d=0;d<a.length;d++)c=document.getElementsByClassName(a[d]),c[0]&&(b+=c[0].clientHeight);return b},S=function(a){"SELECT"!==a.target.tagName&&(a.stopPropagation(),window.dispatchEvent(new CustomEvent("bloqs:mousedown",{detail:event.target})),M=a.currentTarget,O=!0,v=a.shiftKey,document.addEventListener("mousemove",U),document.addEventListener("mouseup",T),document.addEventListener("touchmove",U),document.addEventListener("touchend",T))},T=function(){M=null,document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",T),document.removeEventListener("touchmove",U),document.removeEventListener("touchend",T)},U=function(a){var b=a.pageX||a.touches[0].pageX,c=a.pageY||a.touches[0].pageY;if(O){t=b,u=c,O=!1;var d=M.getBoundingClientRect();p=b-d.left,q=c-d.top,r=R(K),n=d.top,o=d.left,F=E[0].scrollTop}else{var e=b-t,f=c-u;(Math.abs(e)>=5||Math.abs(f)>=5)&&(document.removeEventListener("mousemove",U),document.addEventListener("mousemove",V),document.removeEventListener("touchmove",U),document.addEventListener("touchmove",V))}},V=function(a){var b=null;if(M){switch(b=B[M.getAttribute("data-bloq-id")],window.dispatchEvent(new CustomEvent("bloqs:startMove",{detail:b})),b.isConnectable()||(b.doConnectable(),E.append(b.$bloq)),document.removeEventListener("mouseup",T),document.addEventListener("mouseup",W),document.removeEventListener("touchend",T),document.addEventListener("touchend",W),M.className=M.className.concat(" dragging"),b.bloqData.type){case"statement":case"statement-input":Y(b);break;case"output":_(b);break;case"group":throw"Group cant be moved";default:throw"Not defined bloq dragstart!!"}M=null,N=b}b=b||N;var c=a.clientX||a.touches[0].clientX,d=a.clientY||a.touches[0].clientY,e=aa(b,c,d);switch(b.bloqData.type){case"statement":case"statement-input":x.redrawTree(b,B,z),e>10&&ea([b.connectors[0],x.getLastBottomConnectorUuid(b.uuid,B,z)],a);break;case"output":e>10&&fa(b,D);break;default:throw"Not defined bloq drag!!"}},W=function(a){F=0;var b=$(".connector.available").first(),c=N;X(c,b),window.dispatchEvent(new CustomEvent("bloqs:dragend",{detail:{bloq:c,mouseEvent:a}}))},X=function(a,c){if(c[0]){switch(a.bloqData.type){case"statement":case"statement-input":ba(a,c);break;case"output":da(a,c);break;default:throw"Not defined bloq drag!!"}window.dispatchEvent(new Event("bloqs:connect")),!a.$bloq.closest(".bloq--group")[0]||a.$bloq.closest(".inside-bloq.disabled")[0]&&!b.isEqual(a.$bloq.closest(".inside-bloq.disabled")[0],a.$bloq[0])?(a.disable(),("statement"===a.bloqData.type||"statement-input"===a.bloqData.type)&&x.executeFunctionOnConnectedStatementBloqs("disable",a,B,z)):(a.enable(),("statement"===a.bloqData.type||"statement-input"===a.bloqData.type)&&x.executeFunctionOnConnectedStatementBloqs("enable",a,B,z))}else a.disable(),("statement"===a.bloqData.type||"statement-input"===a.bloqData.type)&&x.executeFunctionOnConnectedStatementBloqs("disable",a,B,z);C=[],D=[],$(".bloq").removeClass("dragging"),$(".connector.available").removeClass("available"),$(".connector.invalid").removeClass("invalid"),$(".connector.valid").removeClass("valid"),$(".bloq--dragging").removeClass("bloq--dragging"),E.focus(),N=null,n=0,o=0,document.removeEventListener("mousemove",V),document.removeEventListener("mouseup",W),document.removeEventListener("touchmove",V),document.removeEventListener("touchend",W)},Y=function(a){var b,c=z[a.connectors[0]].connectedTo;if(v&&(b=z[a.connectors[1]].connectedTo,b&&(z[b].connectedTo=c,c&&(z[c].connectedTo=b),z[a.connectors[1]].connectedTo=null,x.redrawTree(B[z[b].bloqUuid],B,z))),c){var d=B[z[c].bloqUuid],e=x.itsInsideAConnectorRoot(a,B,z);b||(z[c].connectedTo=null),z[a.connectors[0]].connectedTo=null,e&&("group"!==d.bloqData.type||b||d.$bloq.removeClass("with--content"),Z(a),x.redrawTree(d,B,z))}C=[];var f;for(var g in B){var h=B[g];"output"!==h.bloqData.type&&h.isConnectable()&&!x.connectorIsInBranch(h.connectors[0],a.uuid,B,z)&&(f=x.canConnectStatementBloqs(a,h,B,z),f&&(C=C.concat(f)))}for(var i=0;i<C.length;i++)z[C[i]].jqueryObject.addClass("valid")},Z=function(a){var b,c=[a.$bloq],d=z[a.connectors[1]].connectedTo,e=a.$bloq.outerHeight(!0);for(a.$bloq.removeClass("inside-bloq");d;)b=B[z[d].bloqUuid],c.push(b.$bloq),b.$bloq.removeClass("inside-bloq"),b.$bloq[0].style.transform="translate(0px,"+e+"px)",e+=b.$bloq.outerHeight(!0),d=z[b.connectors[1]].connectedTo;x.appendArrayInOneTime(E,c)},_=function(a){var b=x.getOutputConnector(a,A);if(b.connectedTo){a.$bloq.removeClass("nested-bloq");var c=A[b.connectedTo],d=B[c.bloqUuid];c.connectedTo=null,b.connectedTo=null,d.bloqData.returnType&&"fromInput"===d.bloqData.returnType.type&&ia(d),E[0].appendChild(a.$bloq[0])}D=[];for(var e in A)"connector--input"===A[e].data.type&&(x.getBloqByConnectorUuid(e,B,A).isConnectable()&&!A[e].connectedTo&&x.sameConnectionType(a,x.getBloqByConnectorUuid(e,B,A),A[e].data.acceptType,B,A,H,P)&&!x.connectorIsInBranch(e,a.uuid,B,A)?(D.push(e),A[e].jqueryObject.addClass("valid")):A[e].jqueryObject.addClass("invalid"))},aa=function(a,b,c){var d,e,f,g,h=a.$bloq[0].getBoundingClientRect(),i=Math.round(Math.sqrt(Math.pow(n-h.top,2)+Math.pow(o-h.left,2)));return F!==E[0].scrollTop&&(F=E[0].scrollTop),null!==G&&(F=G),d=b-I,e=c-r+F,f=d-p,g=e-q,a.$bloq[0].style.transform="translate("+f+"px,"+g+"px)",i>10&&(n=h.top,o=h.left),"statement-input"===a.bloqData.type&&x.redrawTree(a,B,z),i},ba=function(a,b){var c=b.attr("data-connector-id"),d=$('[data-connector-id="'+c+'"]').attr("data-canconnectwith"),e=x.itsARootConnector(z[c])||x.itsInsideAConnectorRoot(x.getBloqByConnectorUuid(c,B,z),B,z);ga(c,d),e?ca(a,b):ha(c,d)},ca=function(a,b){var c=b.attr("data-connector-id"),d=B[z[c].bloqUuid];if(a.$bloq.addClass("inside-bloq"),a.$bloq.removeAttr("style"),x.itsARootConnector(z[c])){var e=d.$bloq.find(".bloq--extension__content");e.first().append(a.$bloq),d.$bloq.addClass("with--content")}else d.$bloq.after(a.$bloq);for(var f,g=z[a.connectors[1]].connectedTo,h=[];g;)f=B[z[g].bloqUuid],h.push(f.$bloq),f.$bloq.addClass("inside-bloq"),f.$bloq.removeAttr("style"),g=z[f.connectors[1]].connectedTo;a.$bloq.after(x.jqueryObjectsArrayToHtmlToInsert(h)),x.redrawTree(d,B,z)},da=function(a,b){var c=b.attr("data-connector-id"),d=x.getOutputConnector(a,A).uuid;b.append(a.$bloq),a.$bloq.addClass("nested-bloq").removeAttr("style"),A[c].connectedTo=d,A[d].connectedTo=c;var e=x.getBloqByConnectorUuid(c,B,A),f=x.getBloqByConnectorUuid(d,B,A);e.bloqData.returnType&&"fromInput"===e.bloqData.returnType.type&&(f.bloqData.returnType.pointer||ia(e))},ea=function(a){var b,c,d,e,f;C.forEach(function(g){for(d=z[g].jqueryObject,b=0,c=!1;!c&&b<a.length;)e=z[a[b]].jqueryObject,z[a[b]].data.type===z[g].data.accept&&x.canConnectAliases(z[g].data.acceptedAliases,z[a[b]].data.acceptedAliases)&&x.itsOver(e,d,20)?c=!0:b++;f=x.getBloqByConnectorUuid(g,B,z),c?(d.addClass("available"),d.attr("data-canconnectwith",a[b]),"group"===f.bloqData.type&&f.$bloq.addClass("bloq--dragging")):("group"===f.bloqData.type&&f.$bloq.removeClass("bloq--dragging"),d.removeClass("available"),d.removeAttr("data-canconnectwith"))})},fa=function(a,b){var c,d=x.getOutputConnector(a,A);b.forEach(function(a){c=A[a],x.itsOver(d.jqueryObject,c.jqueryObject,0)&&x.sameConnectionType(B[d.bloqUuid],B[c.bloqUuid],c.data.acceptType,B,A,H,P)?c.jqueryObject.addClass("available"):c.jqueryObject.removeClass("available")})},ga=function(a,b){if(z[a].connectedTo){var c,d,e,f;switch(z[a].data.type){case"connector--bottom":c=z[a].connectedTo,d=x.getLastBottomConnectorUuid(z[b].bloqUuid,B,z),z[d].connectedTo=c,z[c].connectedTo=d;break;case"connector--top":e=z[a].connectedTo,f=x.getFirstTopConnectorUuid(z[b].bloqUuid,B,z),z[e].connectedTo=f,z[f].connectedTo=e;break;case"connector--root":c=z[a].connectedTo,d=x.getLastBottomConnectorUuid(z[b].bloqUuid,B,z),z[d].connectedTo=c,z[c].connectedTo=d;break;default:throw"connector on setLogicalConnections no handled "+z[a].data.type}}z[a].connectedTo=b,z[b].connectedTo=a},ha=function(a,b){var c=B[z[a].bloqUuid];switch(c.bloqData.type){case"statement":case"statement-input":x.redrawTree(x.getBloqByConnectorUuid(b,B,z),B,z);break;case"output":break;default:throw"bloqtype not defined in nesting "+c.bloqData.type}},ia=function(a,b,c,d){var e=a.bloqData.createDynamicContent;if(!e)throw"We are adding a softVar on a bloq that not defined the dynamic content";if(!H[e])throw"dynamicContentType not defined "+a.bloqData.name;for(var f=!1,g=0;!f&&g<H[e].length;)H[e][g].bloqUuid===a.uuid&&(f=!0),g++;c=c||x.getTypeFromBloq(a,B,A,H,P),d="statement-input"===a.bloqData.type&&a.bloqData.arguments?d||x.getArgsFromBloq(a,B,A):"";var h;f?(h=H[e][g-1],h.name=b||h.name,h.type=c,h.args=d,h.name?$('option[data-var-id="'+h.id+'"]').attr({value:h.name}).html(h.name):ja(a)):b&&(h={name:b,id:x.generateUUID(),bloqUuid:a.uuid,type:c,args:d},H[e].push(h),$('select[data-dropdowncontent="'+e+'"]').append($("<option>").attr({"data-var-id":h.id,value:h.name}).html(h.name))),ka(H,e,B,A)},ja=function(a){for(var b=a.bloqData.createDynamicContent,c=!1,d=0;!c&&d<H[b].length;)H[b][d].bloqUuid===a.uuid&&(c=!0),d++;if(c){var e=H[b][d-1];H[b].splice(d-1,1),$('option[data-var-id="'+e.id+'"]').remove()}ka(H,b,B,A)},ka=function(a,b,c,d){"returnFunctions"===b||"softwareVars"===b?(i(a,"returnFunctions",c,d),i(a,"softwareVars",c,d)):i(a,b,c,d)},la=function(a,b,c){var d,e=B[a];if(console.log("remove:",a),!e)throw"Cant delete this bloq: "+a;console.log("remove bloq name:",e.bloqData.name);var f,g,h;if(window.dispatchEvent(new Event("bloqs:bloqremoved")),e.$bloq[0].removeEventListener("mousedown",S),e.$bloqInputs)for(d=0;d<e.$bloqInputs.length;d++)e.$bloqInputs[d].off("click");switch((M&&M.getAttribute("data-bloq-id")===a||N&&N.uuid)&&(document.removeEventListener("mouseup",T),document.removeEventListener("mousemove",U),document.removeEventListener("mousemove",V),document.removeEventListener("mouseup",W),document.removeEventListener("touchend",T),document.removeEventListener("touchmove",U),document.removeEventListener("touchmove",V),document.removeEventListener("touchend",W)),e.bloqData.type){case"statement-input":e.$bloq.find(".btn-collapse")[0].removeEventListener("click",m);case"group":for(var i,j=z[e.connectors[2]].connectedTo;j;)i=x.getBloqByConnectorUuid(j,B,z),j=z[i.connectors[1]].connectedTo,la(i.uuid,b,c);case"statement":f=z[e.connectors[0]].connectedTo,g=z[e.connectors[1]].connectedTo;var k;c?(f&&(z[f].connectedTo=null,"connector--root"===z[f].data.type?(k=B[z[f].bloqUuid],"group"===k.bloqData.type&&k.$bloq.removeClass("with--content"),b&&x.redrawTree(x.getBloqByConnectorUuid(f,B,z),B,z)):la(z[f].bloqUuid,b,c)),g&&(z[g].connectedTo=null,la(z[g].bloqUuid,b,c))):f&&g?(z[f].connectedTo=g,z[g].connectedTo=f,b&&x.redrawTree(x.getBloqByConnectorUuid(f,B,z),B,z)):f?(z[f].connectedTo=null,k=B[z[f].bloqUuid],"group"===k.bloqData.type&&k.$bloq.removeClass("with--content"),b&&x.redrawTree(x.getBloqByConnectorUuid(f,B,z),B,z)):g&&(z[g].connectedTo=null);var l;for(d=0;d<e.IOConnectors.length;d++)l=e.IOConnectors[d],"connector--input"===A[l].data.type&&A[l].connectedTo&&la(A[A[l].connectedTo].bloqUuid,b,c);break;case"output":h=A[e.IOConnectors[0]].connectedTo,h&&(A[h].connectedTo=null);break;default:throw"we dont know how to delete: "+e.bloqData.type}e.$bloq.remove();var n;for(d=0;d<e.connectors.length;d++)delete z[e.connectors[d]];for(d=0;d<e.IOConnectors.length;d++)delete A[e.IOConnectors[d]];if(e.bloqData.createDynamicContent)ja(e);else for(n in H)ka(H,n,B,A);delete B[a]},ma=function(a){for(var b,c=a.bloqData,d=0;d<c.content.length;d++)for(var e=0;e<c.content[d].length;e++)b=pa(a,c.content[d][e],H),"DOWN"===c.content[d][e].position?(a.$contentContainerDown.addClass("with-content"),a.$contentContainerDown.append(b)):a.$contentContainer.append(b)},na=function(a,b,c,d,e){var f=$("<div>").attr({"data-connector-id":a});return f.addClass("connector connector--offline "+b.type),e.append(f),z[a]=d,c.connectors.push(a),f},oa=function(a,b){for(var c,d,e,f,g=0;g<a.length;g++){switch(d="connector:"+x.generateUUID(),e={uuid:d,data:a[g],bloqUuid:b.uuid,connectedTo:null},a[g].type){case"connector--top":f="statement-input"===b.bloqData.type?b.$bloq.children(".bloq--statement-input__header"):b.$bloq.children(".bloq--fixed"),c=na(d,a[g],b,e,f);break;case"connector--bottom":f="statement-input"===b.bloqData.type?b.$bloq.find(".bloq--extension--end"):b.$bloq.children(".bloq--fixed"),c=na(d,a[g],b,e,f);break;case"connector--root":f="statement-input"===b.bloqData.type?b.$bloq.children(".bloq--statement-input__header"):b.$bloq,c=na(d,a[g],b,e,f);break;case"connector--input":c=$(b.$bloq.find('.bloqinput[data-connector-name="'+a[g].name+'"]')),c.attr({"data-connector-id":d}).addClass("connector "+a[g].type),e.contentId=c.attr("data-content-id"),A[d]=e,b.IOConnectors.push(d);break;case"connector--output":c=$("<div>").attr({"data-connector-id":d}).addClass("connector connector--offline "+a[g].type),b.$bloq.append(c),e.returnType=b.bloqData.returnType,A[d]=e,b.IOConnectors.push(d);break;case"connector--empty":c=$("<div>"),z[d]=e,b.connectors.push(d);break;default:throw"Connector not defined to build"}e.jqueryObject=c}},pa=function(a,b,c){var e,f,g,h,i=null;switch(b.alias){case"staticDropdown":i=$("<select>"),i.attr({name:"","data-content-id":b.id});var l=[];for(e=0;e<b.options.length;e++)f=$("<option>").attr({value:b.options[e].value,"data-i18n":b.options[e].label}).html(xa(y,b.options[e].label)),l.push(f);x.appendArrayInOneTime(i,l),b.value&&i.val(b.value),i.change(function(){window.dispatchEvent(new Event("bloqs:change"))}),a.bloqData.returnType&&"fromDropdown"===a.bloqData.returnType.type&&i.change(function(){ia(a)});break;case"dynamicDropdown":switch(i=$("<select>"),i.attr({name:"","data-content-id":b.id,"data-dropdowncontent":b.options,"data-value":b.value}),b.options){case"voidFunctions":case"returnFunctions":case"softwareVars":case"classes":case"objects":g=c[b.options],i.change(function(){if("output"===a.bloqData.type){var b=x.getOutputConnector(a,A);if(b.connectedTo){var c=A[b.connectedTo],d=B[c.bloqUuid];d.bloqData.returnType&&"fromInput"===d.bloqData.returnType.type&&ia(d)}}});break;case"allServos":g=[],g=g.concat(P.servos,P.oscillators,P.continuousServos);break;case"sensors":g=[],g=g.concat(P.sensors,P.mkb_lightsensor,P.mkb_linefollower,P.mkb_soundsensor,P.joystick,P.mkb_4buttonKeyPad,P.remoteControl,P.mkb_motionSensor);break;case"varComponents":g=[];for(h in P)P[h].length>=1&&(g=g.concat(P[h]));break;case"clocks":g=[],g=P.clocks;break;case"hts221":g=[],g=P.hts221;break;case"barometer":g=[],g=P.barometer;default:g=P[b.options]}if(!g)throw"Dropdowns not defined in array: "+b.options;if(x.drawDropdownOptions(i,g),b.value){
i.val(b.value);var m=g.find(function(a){return a.name===b.value});i[0].dataset.reference=m?m.uid:"",i[0].dataset.value=b.value,i.val(b.value)}i.change(function(a){i[0].dataset.value=a.currentTarget.value,i[0].dataset.reference=a.currentTarget.selectedOptions[0].dataset.reference,window.dispatchEvent(new Event("bloqs:change"))});break;case"text":i=$("<span>").attr({"data-i18n":b.value}).html(xa(y,b.value));break;case"removableText":i=$("<span>").html(b.value),i.addClass("removabletext");break;case"numberInput":i=$("<input>").attr({type:"text","data-content-id":b.id,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value),i.bind("input",function(){var a=x.getCaretPosition(this),b=x.validNumber($(this).val());$(this).val(b.value),x.setCaretPosition(this,a-b.removedChar)}),i.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:60,comfortZone:30})}),i.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"stringInput":i=$("<input>").attr({type:"text","data-content-id":b.id,"data-content-type":b.alias,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value||xa(y,b.defaultValue)),i.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),i.change(function(){i.val(x.validString(i.val())),window.dispatchEvent(new Event("bloqs:change"))});break;case"charInput":i=$("<input>").attr({type:"text","data-content-id":b.id,"data-content-type":b.alias,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value),i.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),i.change(function(){i.val(x.validChar(i.val())),window.dispatchEvent(new Event("bloqs:change"))});break;case"codeInput":i=$("<input>").attr({type:"text","data-content-id":b.id,"data-content-type":b.alias,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value),i.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),i.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"multilineCodeInput":i=$('<textarea class="msd-elastic: \n;" ng-model="bar" cols="40" rows="1"></textarea>').attr({"data-content-id":b.id,"data-content-type":b.alias,name:b.id,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value),setTimeout(function(){$('[name="'+b.id+'"]').autogrow({onInitialize:!0})},0),i.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"multilineCommentInput":i=$('<textarea class="msd-elastic: \n;" ng-model="bar" cols="40" rows="1"></textarea>').attr({"data-content-id":b.id,"data-content-type":b.alias,name:b.id,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value),setTimeout(function(){$('[name="'+b.id+'"]').autogrow({onInitialize:!0})},0),i.keyup(function(){d.delay(function(){i.val(x.validComment(i.val()))},1e3)}),i.change(function(){i.val(x.validComment(i.val())),window.dispatchEvent(new Event("bloqs:change"))});break;case"varInput":i=$("<input>").attr({type:"text","data-content-id":b.id,"data-placeholder-i18n":b.placeholder,placeholder:xa(y,b.placeholder)}).val(b.value),a.varInputs=[],a.varInputs.push(i),i.addClass("var--input"),i.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),i.keyup(function(){console.log(a),d.delay(function(){var b=x.validName(i.val(),a.uuid,c);i.val(b),b?ia(a,b):ja(a,b)},1e3,a.uuid)}),i.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"bloqInput":i=$("<div>").attr({"data-connector-name":b.name,"data-content-id":b.bloqInputId}),i.addClass("bloqinput"),i.click(k),a.$bloqInputs||(a.$bloqInputs=[]),a.$bloqInputs.push(i);break;case"headerText":i=$("<h3>").html(b.value),i.addClass("headerText");break;case"descriptionText":i=$("<p>").html(b.value),i.addClass("descriptionText");break;case"dotsMatrix":i=$('<div class="bloqs-dotsMatrix">'),i.click(function(a){j(b,a)});break;default:throw"elementSchema not defined: "+b.alias}return i},qa=function(a){if(a!==y){y=a;var b,c,d;for(var e in B){c=B[e].$bloq.find("[data-placeholder-i18n]"),b=B[e].$bloq.find("[data-i18n]");for(var f=0;f<c.length;f++)d=c[f].getAttribute("data-placeholder-i18n"),c[f].placeholder=xa(y,d);for(var h=0;h<b.length;h++)d=b[h].getAttribute("data-i18n"),b[h].innerHTML=xa(y,d)}g.setSuggestedText(xa(y,"suggested"))}},ra=function(){var a,b;for(a in B)if(b=B[a],b.isConnectable())switch(b.bloqData.type){case"statement":case"statement-input":z[b.connectors[0]].connectedTo||la(a);break;case"output":A[b.IOConnectors[0]].connectedTo||la(a);break;case"group":break;default:throw"its free? "+b.bloqData.type}},sa=function(){var a,b,c,d,e=[];for(var f in B)if(a=B[f],a.isConnectable())switch(a.bloqData.type){case"statement":case"statement-input":if(!z[a.connectors[0]].connectedTo){for(b=[a.getBloqsStructure()],d=z[a.connectors[1]].connectedTo;d;)c=x.getBloqByConnectorUuid(d,B,z),b.push(c.getBloqsStructure()),d=z[c.connectors[1]].connectedTo;e.push({position:a.$bloq.position(),bloqGroup:b})}break;case"output":A[a.IOConnectors[0]].connectedTo||(b=[a.getBloqsStructure()],e.push({position:a.$bloq[0].getBoundingClientRect(),bloqGroup:b}));break;case"group":break;default:throw"its free? "+a.bloqData.type}return e},ta=function(a){if(P=a,!w){var b=c.defer();w=setTimeout(function(){w=null,ua(P),b.resolve()},200)}return b.promise},ua=function(b){function c(a,b){b[0]?(a.dataset.reference=b[0].uid,a.dataset.value=b[0].name,a.value=b[0].name):(delete a.dataset.reference,delete a.dataset.value),a.selectedIndex=0}var e,f=(a.bloqs,[]),g=function(a,b){var e=b.find(function(b){return b.uid===a.dataset.reference});d.drawDropdownOptions($(a),b),e?(a.value=e.name,a.dataset.reference=e.uid,a.dataset.value=e.name):c(a,b)},h=null;for(var i in b){h=document.getElementsByClassName("bloqs-tab")[0];var j=h.querySelectorAll('select[data-dropdowncontent="'+i+'"]');e="sensors"===i?b.sensors.concat(b.mkb_lightsensor,b.mkb_linefollower,b.mkb_soundsensor,b.joystick,b.mkb_4buttonKeyPad,b.remoteControl,b.mkb_motionSensor):b[i];for(var k=0,l=j.length;l>k;k++)g(j[k],e);f=f.concat(b[i])}if(h){for(var m=h.querySelectorAll('select[data-dropdowncontent="varComponents"]'),n=0,o=m.length;o>n;n++)g(m[n],f);var p=[];p=p.concat(b.servos,b.oscillators,b.continuousServos);for(var q=h.querySelectorAll('select[data-dropdowncontent="allServos"]'),r=0,s=q.length;s>r;r++)g(q[r],p)}},va=function(){var a;for(a in H)wa(a)},wa=function(a){var b,c;$('select[data-dropdownContent="'+a+'"]').each(function(e,f){b=$(f),c=b.attr("data-value"),d.drawDropdownOptions(b,H[a]),c&&b.val(c)})},xa=function(a,b){return e.texts[a]||(console.error("Language not supported "+a),a="en-GB"),e.texts[a][b]||e.texts["en-GB"][b]||e.texts["es-ES"][b]||b},ya=function(a){if(a.bloqData){this.uuid="bloq:"+x.generateUUID(),a.$field&&!a.$field.is(E)&&(E=a.$field,f.addBloqsTooltip(E)),this.bloqData=b.cloneDeep(a.bloqData),P=a.componentsArray||P,this.connectors=[],this.IOConnectors=[];var c,d=!1,e=this;switch(this.collapseGroupContent=function(){var a=e.$bloq.children(".field--content");a.toggleClass("field--collapsed"),e.connectable=!e.connectable,a.parent().toggleClass("collapsed--field")},this.enable=function(a){if(!d){if(this.$bloq.removeClass("disabled"),this.bloqData.content&&this.bloqData.content[0])for(var b=0;b<this.bloqData.content[0].length;b++)if("bloqInput"===this.bloqData.content[0][b].alias)for(var c,e=0;e<this.IOConnectors.length;e++)c=this.IOConnectors[e],"connector--input"===A[c].data.type&&A[c].connectedTo&&x.getBloqByConnectorUuid(A[c].connectedTo,B,A).enable();if(d=!0,this.connectors[2]&&!a)for(var f,g=z[this.connectors[2]].connectedTo;g;)f=x.getBloqByConnectorUuid(g,B,z),f.enable(),g=z[f.connectors[1]].connectedTo}},this.disable=function(a){if(this.$bloq.addClass("disabled"),d){if(this.bloqData.content&&this.bloqData.content[0])for(var b=0;b<this.bloqData.content[0].length;b++)switch(this.bloqData.content[0][b].alias){case"bloqInput":for(var c,e=0;e<this.IOConnectors.length;e++)c=this.IOConnectors[e],"connector--input"===A[c].data.type&&A[c].connectedTo&&x.getBloqByConnectorUuid(A[c].connectedTo,B,A).disable()}if(d=!1,this.connectors[2]&&!a)for(var f,g=z[this.connectors[2]].connectedTo;g;)f=x.getBloqByConnectorUuid(g,B,z),f.disable(),g=z[f.connectors[1]].connectedTo}},this.itsEnabled=function(){return d},this.doConnectable=function(){if(!c){if(this.bloqData.content&&this.bloqData.content[0])for(var a=0;a<this.bloqData.content[0].length;a++)if("bloqInput"===this.bloqData.content[0][a].alias)for(var b,d=0;d<this.IOConnectors.length;d++)b=this.IOConnectors[d],"connector--input"===A[b].data.type&&A[b].connectedTo&&x.getBloqByConnectorUuid(A[b].connectedTo,B,A).doConnectable();if(this.connectors[2])for(var e,f=z[this.connectors[2]].connectedTo;f;)e=x.getBloqByConnectorUuid(f,B,z),e.doConnectable(),f=z[e.connectors[1]].connectedTo;c=!0,this.$bloq[0].dispatchEvent(new Event("bloq:connectable"))}},this.doNotConnectable=function(){c=!1},this.isConnectable=function(){return c},this.itsFree=function(){return 0===this.$bloq.closest(".bloq--group").length},this.autoRemove=function(){la(this.uuid)},this.$bloq=$("<div>").attr({"data-bloq-id":this.uuid,tabIndex:0}),this.$bloq.addClass("bloq bloq--"+this.bloqData.type+" "+this.bloqData.bloqClass),B[this.uuid]=this,this.doNotConnectable(),this.bloqData.type){case"statement-input":this.$bloq.append('<div class="bloq--statement-input__header"><button class="btn-collapse">-</button></div><div class="bloq--extension"><div class="bloq--extension__content"></div> <div class="bloq--extension--end"></div></div>'),this.$contentContainer=this.$bloq.find(".bloq--statement-input__header"),this.$contentContainerDown=this.$bloq.find(".bloq--extension--end"),ma(this),this.$bloq[0].addEventListener("mousedown",S),this.$bloq[0].addEventListener("touchstart",S),this.$bloq.find(".btn-collapse")[0].addEventListener("click",m),oa(a.bloqData.connectors,this),this.$contentContainer.children().children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$contentContainer.children().children().not(".connector.connector--offline").last().addClass("bloq__inner--last"),this.$contentContainer.children().not(".connector.connector--offline").last().addClass("bloq__inner--last"),this.$contentContainerDown.children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$contentContainerDown.children().not(".connector.connector--offline").last().addClass("bloq__inner--last");break;case"statement":this.$bloq.append('<div class="bloq--fixed">'),this.$contentContainer=this.$bloq.find(".bloq--fixed"),ma(this),this.$bloq[0].addEventListener("mousedown",S),this.$bloq[0].addEventListener("touchstart",S),oa(a.bloqData.connectors,this),this.$bloq.children().children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$bloq.children().children().not(".connector.connector--offline").last().addClass("bloq__inner--last");break;case"output":this.$contentContainer=this.$bloq,ma(this),this.$bloq[0].addEventListener("mousedown",S),this.$bloq[0].addEventListener("touchstart",S),oa(a.bloqData.connectors,this),this.$bloq.children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$bloq.children().not(".connector.connector--offline").last().addClass("bloq__inner--last");break;case"group":this.$bloq.append('<div class="field--header"><button class="btn btn--collapsefield"></button><h3 data-i18n="'+this.bloqData.headerText+'">'+xa(y,this.bloqData.headerText)+'</h3></div><div class="field--content"><div class="bloq--extension--info"> <div class="bloq__info"><p class="bloq__info--text" data-i18n="'+this.bloqData.descriptionText+'">'+xa(y,this.bloqData.descriptionText)+'</p></div><p class="bloq--drag-bloq" data-i18n="drag-bloq">'+xa(y,"drag-bloq")+'</p></div><div class="bloq--extension__content"></div></div>'),oa(a.bloqData.connectors,this),this.$bloq.find(".connector--root").addClass("connector--root--group"),this.$bloq.find(".field--header .btn").on("click",this.collapseGroupContent),this.$bloq.find(".field--header h3").on("click",this.collapseGroupContent);break;default:throw"bloqData "+this.bloqData.type+"not defined in bloq construction"}if(this.bloqData.createDynamicContent){var g=x.validName(this.$bloq.find("input.var--input").val(),this.uuid);g?ia(this,g):ja(this,g)}return this.getIOConnectorUuidByContentId=function(a){for(var b=!1,c=0,d=null;!b&&c<this.IOConnectors.length;)A[this.IOConnectors[c]].contentId===a&&(b=!0,d=this.IOConnectors[c]),c++;return d},this.getBloqsStructure=function(a){var c,d;c=a?b.cloneDeep(this.bloqData):{name:this.bloqData.name,content:[[]]},c.enable=this.itsEnabled();var e=this.connectors[2];if(e){c.childs=[];for(var f=z[e].connectedTo;f;)d=x.getBloqByConnectorUuid(f,B,z),c.childs.push(d.getBloqsStructure(a)),f=z[d.connectors[1]].connectedTo}var g,h,i,j;if(this.bloqData.content[0])for(var k=0;k<this.bloqData.content[0].length;k++){switch(g=null,this.bloqData.content[0][k].alias){case"varInput":case"stringInput":case"numberInput":case"multilineCodeInput":case"multilineCommentInput":case"codeInput":case"charInput":h=this.$bloq.find('[data-content-id="'+this.bloqData.content[0][k].id+'"]').val(),h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h});break;case"bloqInput":var l,m;l=this.getIOConnectorUuidByContentId(this.bloqData.content[0][k].bloqInputId),"connector--input"===A[l].data.type&&A[l].connectedTo&&(m=x.getBloqByConnectorUuid(A[l].connectedTo,B,A),g={alias:this.bloqData.content[0][k].alias,bloqInputId:this.bloqData.content[0][k].bloqInputId,value:m.getBloqsStructure(a)});break;case"dynamicDropdown":j=this.$bloq.find('select[data-content-id="'+this.bloqData.content[0][k].id+'"][data-dropdowncontent="'+this.bloqData.content[0][k].options+'"]').attr("data-value"),i=this.$bloq.find('select[data-content-id="'+this.bloqData.content[0][k].id+'"][data-dropdowncontent="'+this.bloqData.content[0][k].options+'"]').val();var n,o,p=this.bloqData.content[0][k].options,q=Object.keys(H).indexOf(p),r=P.sensors.concat(P.mkb_lightsensor,P.mkb_linefollower,P.mkb_soundsensor,P.joystick,P.mkb_4buttonKeyPad,P.remoteControl,P.mkb_motionSensor);if(-1!==q)for(h=i,o=0;!n&&o<H[p].length;)H[p][o].name===h&&(n=H[p][o].type||-1),o++;else if("sensors"===p)for(h=i,o=0;!n&&o<r.length;)r[o].name===h&&(n=r[o].dataReturnType),o++;else h=j||i;h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h,valueType:n});break;case"staticDropdown":h=this.$contentContainer.find('> select[data-content-id="'+this.bloqData.content[0][k].id+'"]').val(),h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h});break;case"text":break;case"dotsMatrix":h=this.bloqData.content[0][k].value,h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h});break;default:throw"I dont know how to get the structure from this contentType :( "+this.bloqData.content[0][k].alias}g&&(a?(c.content[0][k].value=g.value,c.content[0][k].valueType=g.valueType):c.content[0].push(g))}return c},window.dispatchEvent(new CustomEvent("bloqs:created",{detail:{bloq:this}})),this}console.error("the bloqData its empty.")},za=function(){H={voidFunctions:[],returnFunctions:[],softwareVars:[],classes:[],objects:[]}},Aa=function(a,c,e,f){var g,h,i,j,k,l,m,n,o=b.cloneDeep(e[a.name]);if(o||console.error("no original schema",a),h=d.fillSchemaWithContent(o,a),g=new ya({bloqData:h,componentsArray:c,$field:f}),a.content)for(n=0;n<a.content[0].length;n++)"bloqInput"===a.content[0][n].alias&&(l=g.getIOConnectorUuidByContentId(a.content[0][n].bloqInputId),m=g.$bloq.find('[data-connector-id="'+l+'"]').first(),k=Aa(a.content[0][n].value,c,e,f),k.$bloq.addClass("nested-bloq"),A[l]||console.debug("not connector?",o),A[l].connectedTo=k.IOConnectors[0],A[k.IOConnectors[0]].connectedTo=l,m.append(k.$bloq));if(a.childs)for(m=g.$bloq.find(".bloq--extension__content"),i=g.connectors[2],a.childs.length>0&&g.$bloq.addClass("with--content"),n=0;n<a.childs.length;n++)j=Aa(a.childs[n],c,e,f),z[i].connectedTo=j.connectors[0],z[j.connectors[0]].connectedTo=i,i=j.connectors[1],j.$bloq.addClass("inside-bloq"),m.append(j.$bloq);return a.enable?g.enable(!0):g.disable(),g.bloqData.createDynamicContent&&ia(g),g};return a.Bloq=ya,a.updateSoftVar=ia,a.connectors=z,a.IOConnectors=A,a.bloqs=B,a.removeBloq=la,a.translateBloqs=qa,a.getFreeBloqs=sa,a.destroyFreeBloqs=ra,a.updateDropdowns=va,a.setOptions=Q,a.buildBloqWithContent=Aa,a.clearSoftwareArrays=za,a.startBloqsUpdate=ta,a}(window.bloqs=window.bloqs||{},_,Q,bloqsUtils,bloqsLanguages,bloqsTooltip,bloqsSuggested,bloqsDotsMatrix,void 0);