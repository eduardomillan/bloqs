...
};break;case"lcd":d=["Wire.h","BitbloqLiquidCrystal.h"],c={name:a.components[h].name,type:"LiquidCrystal",arguments:["0"]},b=a.components[h].name+".begin(16, 2);"+a.components[h].name+".clear();";break;case"RGBled":d=["BitbloqRGB.h"],c={name:a.components[h].name,type:"ZumRGB",arguments:[a.components[h].pin.r,a.components[h].pin.g,a.components[h].pin.b]};break;case"rtc":d=["Wire.h","BitbloqRTC.h"],c={name:a.components[h].name,type:"RTC_DS1307"};break;case"hts221":d=["Wire.h","BitbloqHTS221.h","HTS221_Registers.h"],c={name:a.components[h].name,type:"HTS221"},b="Wire.begin();\n"+a.components[h].name+".begin();";break;case"us":d=["BitbloqUS.h"],c={name:a.components[h].name,type:"US",arguments:[a.components[h].pin.trigger,a.components[h].pin.echo]};break;case"servo":case"servocont":a.components[h].oscillator&&"false"!==a.components[h].oscillator?(d=["Servo.h","Wire.h","BitbloqOscillator.h"],c={name:a.components[h].name,type:"Oscillator"}):(d=["Servo.h"],c={name:a.components[h].name,type:"Servo"}),b=a.components[h].name+".attach("+a.components[h].pin.s+");";break;case"irs2":d=["BitbloqLineFollower.h"],c={name:a.components[h].name,type:"LineFollower",arguments:[a.components[h].pin.s1,a.components[h].pin.s2]};break;case"mkb_ultrasound":d=["BitbloqUS.h"],c={name:a.components[h].name,type:"BitbloqUltrasound",arguments:[g+"::ports["+a.components[h].pin.s+"][2]",g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();"]=!0;break;case"mkb_linefollower":c={name:a.components[h].name+"_1",type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][1]"},b="pinMode("+a.components[h].name+"_1 , INPUT);",o(c,{},a),x[b]=!0,c={name:a.components[h].name+"_2",type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+"_2 , INPUT);";break;case"mkb_lightsensor":b="pinMode("+a.components[h].name+", INPUT);",c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"};break;case"mkb_joystick":d=["BitbloqJoystick.h"];var i,j=2;for(i=0;i<j;i++)c={name:a.components[h].name+"_"+(i+1),type:"const int",equals:g+"::ports["+a.components[h].pin.s+"]["+(i+1)+"]"},b="pinMode("+a.components[h].name+"_"+(i+1)+" , INPUT);",o(c,{},a),x[b]=!0;c={name:a.components[h].name,type:"Joystick",arguments:[a.components[h].name+"_1",a.components[h].name+"_2",0]};break;case"mkb_soundsensor":c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+", INPUT);",o(c,{},a),x[b]=!0;break;case"mkb_pot":c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+", INPUT);",o(c,{},a),x[b]=!0;break;case"mkb_4buttonKeyPad":d=["BitbloqButtonPad.h"],c={name:a.components[h].name,type:"BitbloqMe4ButtonPad",arguments:[g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();"]=!0;break;case"mkb_ledmatrix":d=["BitbloqMeLEDMatrix.h"],c={name:a.components[h].name,type:"BitbloqMeLEDMatrix",arguments:[g+"::ports["+a.components[h].pin.s+"][1]",g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();\n"+a.components[h].name+".setBrightness(6);\n"+a.components[h].name+".setColorIndex(1);"]=!0;break;case"mkb_display7seg":d=["Bitbloq7SegmentDisplay.h"],c={name:a.components[h].name,type:"Bitbloq7SegmentDisplay",arguments:[g+"::ports["+a.components[h].pin.s+"][1]",g+"::ports["+a.components[h].pin.s+"][2]"]},y[a.components[h].name+".setup();"]=!0;break;case"mkb_remote":d=["IRremoteInt.h","IRremote.h","BitbloqIRControl.h"],c={name:a.board,type:g},y[a.board+".setup();"]=!0;break;case"mkb_motionSensor":c={name:a.components[h].name+"_mode",type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][1]"},b="pinMode("+a.components[h].name+"_mode , OUTPUT);",o(c,{},a),x[b]=!0,c={name:a.components[h].name,type:"const int",equals:g+"::ports["+a.components[h].pin.s+"][2]"},b="pinMode("+a.components[h].name+" , INPUT);",o(c,{},a),x[b]=!0,b="digitalWrite("+a.components[h].name+"_mode , 0);",o(c,{},a),x[b]=!0}c&&o(c,{},a),b&&(x[b]=!0),e&&(z[e]=!0),f&&(A[f]=!0);for(var k=0;k<d.length;k++)v[d[k]]=!0}}function o(a,b,c){var d=a.name;if(d=k(d,b,c),a.arguments){for(var e=0;e<a.arguments.length;e++)a.arguments[e]=k(a.arguments[e],b,c);if(a.arguments.indexOf("undefined")>-1){for(var f=_.clone(a.arguments),g=0;g<f.length;g++)"undefined"===f[g]&&(f[g]=String(g));var h=d+String(f||"")}}var i=d+String(a.arguments||"");h&&w[h]||(w[i]={equals:k(a.equals,b,c),type:a.type,name:a.name,realName:d,arguments:a.arguments})}var p,q=/{([^{].[^(\s]*?)}/,r=/º\[([^{].*?)\.(.*?)\]/,s=/@{([^{].*?)\.(.*?)}/,t=/¬{([^{].*?)\.(.*?)}/,u=/\${CLASS-OUTSIDE}/,v={},w={},x={},y={},z={},A={},B={withoutAsterisk:function(a){return a.replace("*","")},formatPin:function(a){return a.indexOf("A")!==-1&&(a=a.replace(/\"/g,"")),a},readPin:function(a){var b;return b=a.indexOf("A")!==-1?"analogRead("+a+")":"digitalRead("+a+")"},getHashCodeFromString:function(a){return a.replace("{","").replace("}","").replace(/ /g,"").replace(/0x/g,"").replace(/,/g,"")},readSensor:function(a,b,c){for(var d,e,f=0;!e&&f<c.components.length;)c.components[f].name===a&&(e=c.components[f]),f++;if(e)switch(e.type){case"analog":d="analogRead("+a+")";break;case"digital":d="digitalRead("+a+")";break;case"LineFollower":d="(float *) "+a+".read()";break;case"mkb_linefollower":d="digitalRead("+a+"_1) + digitalRead("+a+"_2) * 2";break;case"mkb_integrated_analogPinButton":d="robot.isButtonPushed()";break;case"mkb_integrated_lightsensor":var g=e.pin.s||"";d="robot.readLightSensor("+g+")";break;case"remote":d=c.board+".getInfraredControlCommand()";break;default:d=a+".read()"}return d||""}};return a.getCode=b,a}(window.arduinoGeneration=window.arduinoGeneration||{},void 0),function(a,b,c){function d(a,b){v=a||v,u=b||u}function e(a){u?(a=a||{},a.workspaceWidth=a.workspaceWidth||0,a.workspaceHeight=a.workspaceHeight||0,a.launcherTopPoint=a.launcherTopPoint||0,a.launcherBottomPoint=a.launcherBottomPoint||0,a.suggestedBloqs=a.suggestedBloqs||[],a.suggestedText=a.suggestedText||"",a.fieldOffsetTop=a.fieldOffsetTop||0,a.fieldOffsetLeft=a.fieldOffsetLeft||0,a.fieldOffsetRight=a.fieldOffsetRight||0,a.fieldScrollTop=a.fieldScrollTop||0,a.fieldScrollLeft=a.fieldScrollLeft||0,x=a.showWindowCallback,console.log("params.suggestedBloqs",a.suggestedBloqs),f(),a.suggestedText&&i(a.suggestedText),h({launcherTopPoint:a.launcherTopPoint,launcherHeight:a.launcherHeight,launcherBottomPoint:a.launcherBottomPoint,suggestedWindowWidth:q.offsetWidth,suggestedWindowHeight:q.offsetHeight,workspaceHeight:a.workspaceHeight,workspaceWidth:a.workspaceWidth,fieldOffsetTop:a.fieldOffsetTop,fieldOffsetLeft:a.fieldOffsetLeft,fieldOffsetRight:a.fieldOffsetRight,fieldScrollTop:a.fieldScrollTop,fieldScrollLeft:a.fieldScrollLeft}),a.suggestedBloqs&&a.suggestedBloqs.length>0?m(a.suggestedBloqs):(j(a.noSuggestedText),console.log("no bloqs suggested"))):console.error("You must set the bloqSchemas")}function f(){if(q)q.className=q.className.replace("hide","");else{r=k(),q=document.createElement("div"),q.className="suggestion-window",t=document.createElement("div"),t.className="bloqs-container";var a=document.createElement("div");a.className+="triangle top";var b=document.createElement("div");b.className+="triangle bottom",q.appendChild(a),q.appendChild(r),q.appendChild(t),q.appendChild(b),v.appendChild(q)}return w=[],document.addEventListener("mousedown",l),document.addEventListener("touchstart",l),window.addEventListener("bloqs:mousedown",l),window.addEventListener("bloqs:dragend",n),q}function g(){q.className.indexOf("hide")===-1&&(q.className+=" hide"),document.removeEventListener("mousedown",l),document.removeEventListener("touchstart",l),window.removeEventListener("bloqs:mousedown",l),window.removeEventListener("bloqs:dragend",n)}function h(a){console.log("place window in the available space",a),q.className=q.className.replace(" right",""),q.className=q.className.replace(" top","");var b=6,c=21,d={},e=a.workspaceHeight+a.fieldOffsetTop-a.launcherBottomPoint.top,f=a.launcherTopPoint.top-a.fieldOffsetTop,g=a.suggestedWindowHeight+b,h=a.workspaceWidth-a.fieldOffsetRight-(a.launcherBottomPoint.left-a.fieldOffsetLeft),i=a.launcherBottomPoint.left-a.fieldOffsetLeft,j=a.suggestedWindowWidth+c;e>=g||e>=f||f<g?d.top=a.launcherBottomPoint.top-a.fieldOffsetTop+b+a.fieldScrollTop:(d.top=a.launcherTopPoint.top-a.fieldOffsetTop-a.suggestedWindowHeight-b+a.fieldScrollTop,q.className+=" top"),h>=j||h>=i||i<j?d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-c+a.fieldScrollLeft:(d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-a.suggestedWindowHeight+c+a.fieldScrollLeft,q.className+=" left"),q.style.transform="translate("+d.left+"px,"+d.top+"px)"}function i(a){s&&(s.innerHTML=a)}function j(a){var b=document.createElement("p");b.innerHTML=a,t&&t.appendChild(b)}function k(){s=document.createElement("h3");var a=document.createElement("div");return a.className+="sugg-header",a.appendChild(s),a}function l(a){console.log("actionWithWindowOpenListener",a);var b;b=1!==a.detail?a.detail:a.target,c.findAncestor(b,"suggestion-window")||p()}function m(a){for(var b,c,d=0;d<a.length;d++)b=new bloqs.Bloq({bloqData:u[a[d]]}),w.push(b),c=document.createElement("div"),c.className+="bloq-container",c.appendChild(b.$bloq[0]),t.appendChild(c),b.$bloq[0].addEventListener("click",o)}function n(a){console.log("onSuggestedBloqDragEnd",a.detail.bloq),p(a.detail.bloq.uuid)}function o(a){console.log("onSuggestedBloqClick",a);var b=a.currentTarget,c=b.getAttribute("data-bloq-id");p(c,!0)}function p(a,b){for(var c=0;c<w.length;c++)w[c].$bloq[0].removeEventListener("click",o),w[c].uuid!==a&&w[c].autoRemove();t.innerHTML="",a&&b&&x(a),g()}var q,r,s,t,u,v,w,x;return a.init=d,a.showSuggestedWindow=e,a.setSuggestedText=i,a}(window.bloqsSuggested=window.bloqsSuggested||{},bloqsLanguages,bloqsUtils,void 0),function(a,b,c){function d(a,b){s=a||s}function e(a){a=a||{},a.workspaceWidth=a.workspaceWidth||0,a.workspaceHeight=a.workspaceHeight||0,a.launcherTopPoint=a.launcherTopPoint||0,a.launcherBottomPoint=a.launcherBottomPoint||0,a.fieldOffsetTop=a.fieldOffsetTop||0,a.fieldOffsetLeft=a.fieldOffsetLeft||0,a.fieldOffsetRight=a.fieldOffsetRight||0,a.fieldScrollTop=a.fieldScrollTop||0,a.fieldScrollLeft=a.fieldScrollLeft||0,t=a.showWindowCallback,l(a),h(a.dotsMatrixOptions.value,a.dotsMatrixOptions.options),p({launcherTopPoint:a.launcherTopPoint,launcherHeight:a.launcherHeight,launcherBottomPoint:a.launcherBottomPoint,bloqsWindowWidth:q.offsetWidth,bloqsWindowHeight:q.offsetHeight,workspaceHeight:a.workspaceHeight,workspaceWidth:a.workspaceWidth,fieldOffsetTop:a.fieldOffsetTop,fieldOffsetLeft:a.fieldOffsetLeft,fieldOffsetRight:a.fieldOffsetRight,fieldScrollTop:a.fieldScrollTop,fieldScrollLeft:a.fieldScrollLeft})}function f(a){console.log(a.dotsMatrixOptions);for(var b,c,d=0;d<a.dotsMatrixOptions.options.rows;d++){b=document.createElement("div"),b.className+="bloqs-dots-row",v[d]=[];for(var e=0;e<a.dotsMatrixOptions.options.columns;e++)c=document.createElement("div"),c.className+="bloqs-dots-dot",v[d].push(c),v[d][e].addEventListener("mouseover",k),b.appendChild(c);r.appendChild(b)}}function g(a,b,d){for(var e=c.createMatrix(b,d),f=a.replace("{","").replace("}","").replace(/ /g,"").replace(/0x/g,"").split(","),g=0;g<f.length;g++)f[g]=parseInt(f[g],16).toString(2),f[g]=f[g].split("").reverse().join("");console.log(f[g]);for(var h=0;h<f.length;h++)for(var i=0;i<b;i++)"1"===f[h].charAt(i)?e[b-1-i][h]=!0:e[b-1-i][h]=!1;return e}function h(a,b){console.log("setMatrix",a),a=a?g(a,b.rows,b.columns):c.createMatrix(b.rows,b.columns);for(var d=0;d<v.length;d++)for(var e=0;e<v[d].length;e++)a[d][e]?v[d][e].className.indexOf("active")===-1&&(v[d][e].className+=" active"):v[d][e].className=v[d][e].className.replace("active","")}function i(){for(var a=[],b=[],c=0;c<v[0].length;c++)b[c]="";for(var d=0;d<v.length;d++){a[d]=[];for(var e=0;e<v[d].length;e++)a[d][e]=v[d][e].className.indexOf("active")!==-1,a[d][e]?b[e]+="1":b[e]+="0"}for(var f=0;f<b.length;f++)b[f]="0x"+parseInt(b[f],2).toString(16);return console.log(b),b=b.toString(),console.log(b),b}function j(a){var b=a.target;b.className.indexOf("active")===-1?b.className+=" active":b.className=b.className.replace("active",""),i()}function k(a){if(console.log("over"),w){var b=a.target;b.className.indexOf("active")===-1&&(b.className+=" active")}}function l(a){if(q)o();else{q=document.createElement("div"),q.className="dotsMatrix-window",r=document.createElement("div"),r.className="dots-container";var b=document.createElement("div");b.className+="triangle top";var c=document.createElement("div");c.className+="triangle bottom",f(a),q.addEventListener("mousedown",function(a){q.addEventListener("mouseup",function(){w=!1}),w=!0,j(a),console.log("activating")}),q.addEventListener("mouseleave",function(){w=!1,m()}),q.appendChild(b),q.appendChild(r),q.appendChild(c),s.appendChild(q)}return q}function m(){u||(q.addEventListener("mouseover",n),q.className.indexOf("opacity0")===-1&&(q.className+=" opacity0"),u=setTimeout(function(){u=null,q.className.indexOf("hide")===-1&&(q.className+=" hide"),q.removeEventListener("mouseover",n),t(i())},500))}function n(){q.removeEventListener("mouseover",n),console.log("mouseover cancel hide"),o(),clearTimeout(u),u=null}function o(){q.className=q.className.replace("opacity0","").replace("hide","")}function p(a){console.log("place window in the available space",a),q.className=q.className.replace(" right",""),q.className=q.className.replace(" top","");var b=0,c=31,d={},e=a.workspaceHeight+a.fieldOffsetTop-a.launcherBottomPoint.top,f=a.launcherTopPoint.top-a.fieldOffsetTop,g=a.bloqsWindowHeight+b,h=a.workspaceWidth-a.fieldOffsetRight-(a.launcherBottomPoint.left-a.fieldOffsetLeft),i=a.launcherBottomPoint.left-a.fieldOffsetLeft,j=a.bloqsWindowWidth+c;e>=g||e>=f||f<g?d.top=a.launcherBottomPoint.top-a.fieldOffsetTop+b+a.fieldScrollTop:(d.top=a.launcherTopPoint.top-a.fieldOffsetTop-a.bloqsWindowHeight-b+a.fieldScrollTop,q.className+=" top"),h>=j||h>=i||i<j?d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-c+a.fieldScrollLeft:(d.left=a.launcherBottomPoint.left-a.fieldOffsetLeft-a.bloqsWindowHeight+c+a.fieldScrollLeft,q.className+=" left"),q.style.transform="translate("+d.left+"px,"+d.top+"px)"}var q,r,s,t,u,v=[],w=!1;return a.init=d,a.showDotsWindow=e,a}(window.bloqsDotsMatrix=window.bloqsDotsMatrix||{},bloqsLanguages,bloqsUtils,void 0),function(a,b,c,d,e,f,g){function h(a,b,c,d){for(var e,f=0;f<a[b].length;f++)e=a[b][f],e.type=w.getTypeFromBloq(c[e.bloqUuid],c,d,a,O)}function i(a,b){var c=b.target.getBoundingClientRect(),d=D[0].getBoundingClientRect(),e={launcherTopPoint:{top:c.top,left:c.left},launcherBottomPoint:{top:c.bottom,left:c.left},launcherHeight:c.height,workspaceHeight:d.height,workspaceWidth:d.width,fieldOffsetTop:Q(J),fieldOffsetLeft:H,fieldOffsetRight:I,fieldScrollTop:D[0].scrollTop,fieldScrollLeft:D[0].scrollLeft,dotsMatrixOptions:a};e.showWindowCallback=function(b){a.value=b},g.showDotsWindow(e)}function j(a){if(console.log("click input",a),a.target.hasAttribute("data-connector-name")){var b=a.target.getAttribute("data-connector-id");console.log("id",b);var c=w.getBloqByConnectorUuid(b,A,z);if(console.log(c.itsEnabled()),c.itsEnabled()){a.stopPropagation();var d=a.target.getBoundingClientRect(),e=D[0].getBoundingClientRect(),g={suggestedText:wa(x,"suggested"),noSuggestedText:wa(x,"no-suggested"),launcherTopPoint:{top:d.top,left:d.left},launcherBottomPoint:{top:d.bottom,left:d.left},launcherHeight:d.height,workspaceHeight:e.height,workspaceWidth:e.width,fieldOffsetTop:Q(J),fieldOffsetLeft:H,fieldOffsetRight:I,fieldScrollTop:D[0].scrollTop,fieldScrollLeft:D[0].scrollLeft,availableBloqs:r};z[b]?g.suggestedBloqs=z[b].data.suggestedBloqs:y[b]&&(g.suggestedBloqs=y[b].data.suggestedBloqs),g.suggestedBloqs=k(g.suggestedBloqs,O,G,g.availableBloqs),g.showWindowCallback=function(a){var d=A[a];d.isConnectable()||d.doConnectable(),W(d,z[b].jqueryObject),window.dispatchEvent(new CustomEvent("bloqs:suggestedAdded",{detail:c}))},f.showSuggestedWindow(g)}}}function k(a,b,c,d){for(var e=[],f=0;f<a.length;f++)if(!d||d&&d.indexOf(a[f])>-1)switch(a[f]){case"selectVariable":c.softwareVars.length>0&&e.push(a[f]);break;case"readSensor":b.sensors.length>0&&e.push(a[f]);break;default:e.push(a[f])}return e}function l(a){a.target.parentElement.parentElement.className.indexOf(" collapsed")===-1?(a.target.parentElement.parentElement.className=a.target.parentElement.parentElement.className.concat(" collapsed"),a.target.innerHTML="+"):(a.target.parentElement.parentElement.className=a.target.parentElement.parentElement.className.replace(" collapsed",""),a.target.innerHTML="-")}var m,n,o,p,q,r,s,t,u,v,w=c,x="es-ES",y={},z={},A={},B=[],C=[],D=null,E=0,F=null,G={voidFunctions:[],returnFunctions:[],softwareVars:[],classes:[],objects:[]},H=0,I=0,J=[],K=0,L=null,M=null,N=null,O=c.getEmptyComponentsArray(),P=function(a){J=a.fieldOffsetTopSource||J||[],H=a.fieldOffsetLeft||H||0,I=a.fieldOffsetRight||I||0,K=a.fieldOffsetTopForced||K||0,r=a.availableBloqs,(0===a.forcedScrollTop||a.forcedScrollTop)&&(F=a.forcedScrollTop),f.init(a.suggestionWindowParent,a.bloqSchemas),g.init(a.dotsMatrixWindowParent),x=a.lang||"es-ES"},Q=function(a){var b=0;if(K)b=K;else for(var c,d=0;d<a.length;d++)c=document.getElementsByClassName(a[d]),c[0]&&(b+=c[0].clientHeight);return b},R=function(a){"SELECT"!==a.target.tagName&&(a.stopPropagation(),window.dispatchEvent(new CustomEvent("bloqs:mousedown",{detail:event.target})),L=a.currentTarget,N=!0,u=a.shiftKey,document.addEventListener("mousemove",T),document.addEventListener("mouseup",S),document.addEventListener("touchmove",T),document.addEventListener("touchend",S))},S=function(){L=null,document.removeEventListener("mousemove",T),document.removeEventListener("mouseup",S),document.removeEventListener("touchmove",T),document.removeEventListener("touchend",S)},T=function(a){var b=a.pageX||a.touches[0].pageX,c=a.pageY||a.touches[0].pageY;if(N){s=b,t=c,N=!1;var d=L.getBoundingClientRect();o=b-d.left,p=c-d.top,q=Q(J),m=d.top,n=d.left,E=D[0].scrollTop}else{var e=b-s,f=c-t;(Math.abs(e)>=5||Math.abs(f)>=5)&&(document.removeEventListener("mousemove",T),document.addEventListener("mousemove",U),document.removeEventListener("touchmove",T),document.addEventListener("touchmove",U))}},U=function(a){var b=null;if(L){switch(b=A[L.getAttribute("data-bloq-id")],window.dispatchEvent(new CustomEvent("bloqs:startMove",{detail:b})),b.isConnectable()||(b.doConnectable(),D.append(b.$bloq)),document.removeEventListener("mouseup",S),document.addEventListener("mouseup",V),document.removeEventListener("touchend",S),document.addEventListener("touchend",V),L.className=L.className.concat(" dragging"),b.bloqData.type){case"statement":case"statement-input":X(b);break;case"output":Z(b);break;case"group":throw"Group cant be moved";default:throw"Not defined bloq dragstart!!"}L=null,M=b}b=b||M;var c=a.clientX||a.touches[0].clientX,d=a.clientY||a.touches[0].clientY,e=_(b,c,d);switch(b.bloqData.type){case"statement":case"statement-input":w.redrawTree(b,A,y),e>10&&da([b.connectors[0],w.getLastBottomConnectorUuid(b.uuid,A,y)],a);break;case"output":e>10&&ea(b,C);break;default:throw"Not defined bloq drag!!"}},V=function(a){E=0;var b=$(".connector.available").first(),c=M;W(c,b),window.dispatchEvent(new CustomEvent("bloqs:dragend",{detail:{bloq:c,mouseEvent:a}}))},W=function(a,c){if(c[0]){switch(a.bloqData.type){case"statement":case"statement-input":aa(a,c);break;case"output":ca(a,c);break;default:throw"Not defined bloq drag!!"}window.dispatchEvent(new Event("bloqs:connect")),!a.$bloq.closest(".bloq--group")[0]||a.$bloq.closest(".inside-bloq.disabled")[0]&&!b.isEqual(a.$bloq.closest(".inside-bloq.disabled")[0],a.$bloq[0])?(a.disable(),"statement"!==a.bloqData.type&&"statement-input"!==a.bloqData.type||w.executeFunctionOnConnectedStatementBloqs("disable",a,A,y)):(a.enable(),"statement"!==a.bloqData.type&&"statement-input"!==a.bloqData.type||w.executeFunctionOnConnectedStatementBloqs("enable",a,A,y))}else a.disable(),"statement"!==a.bloqData.type&&"statement-input"!==a.bloqData.type||w.executeFunctionOnConnectedStatementBloqs("disable",a,A,y);B=[],C=[],$(".bloq").removeClass("dragging"),$(".connector.available").removeClass("available"),$(".connector.invalid").removeClass("invalid"),$(".connector.valid").removeClass("valid"),$(".bloq--dragging").removeClass("bloq--dragging"),D.focus(),M=null,m=0,n=0,document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",V),document.removeEventListener("touchmove",U),document.removeEventListener("touchend",V)},X=function(a){var b,c=y[a.connectors[0]].connectedTo;if(u&&(b=y[a.connectors[1]].connectedTo,b&&(y[b].connectedTo=c,c&&(y[c].connectedTo=b),y[a.connectors[1]].connectedTo=null,w.redrawTree(A[y[b].bloqUuid],A,y))),c){var d=A[y[c].bloqUuid],e=w.itsInsideAConnectorRoot(a,A,y);b||(y[c].connectedTo=null),y[a.connectors[0]].connectedTo=null,e&&("group"!==d.bloqData.type||b||d.$bloq.removeClass("with--content"),Y(a),w.redrawTree(d,A,y))}B=[];var f;for(var g in A){var h=A[g];"output"!==h.bloqData.type&&h.isConnectable()&&!w.connectorIsInBranch(h.connectors[0],a.uuid,A,y)&&(f=w.canConnectStatementBloqs(a,h,A,y),f&&(B=B.concat(f)))}for(var i=0;i<B.length;i++)y[B[i]].jqueryObject.addClass("valid")},Y=function(a){var b,c=[a.$bloq],d=y[a.connectors[1]].connectedTo,e=a.$bloq.outerHeight(!0);for(a.$bloq.removeClass("inside-bloq");d;)b=A[y[d].bloqUuid],c.push(b.$bloq),b.$bloq.removeClass("inside-bloq"),b.$bloq[0].style.transform="translate(0px,"+e+"px)",e+=b.$bloq.outerHeight(!0),d=y[b.connectors[1]].connectedTo;w.appendArrayInOneTime(D,c)},Z=function(a){var b=w.getOutputConnector(a,z);if(b.connectedTo){a.$bloq.removeClass("nested-bloq");var c=z[b.connectedTo],d=A[c.bloqUuid];c.connectedTo=null,b.connectedTo=null,d.bloqData.returnType&&"fromInput"===d.bloqData.returnType.type&&ha(d),D[0].appendChild(a.$bloq[0])}C=[];for(var e in z)"connector--input"===z[e].data.type&&(w.getBloqByConnectorUuid(e,A,z).isConnectable()&&!z[e].connectedTo&&w.sameConnectionType(a,w.getBloqByConnectorUuid(e,A,z),z[e].data.acceptType,A,z,G,O)&&!w.connectorIsInBranch(e,a.uuid,A,z)?(C.push(e),z[e].jqueryObject.addClass("valid")):z[e].jqueryObject.addClass("invalid"))},_=function(a,b,c){var d,e,f,g,h=a.$bloq[0].getBoundingClientRect(),i=Math.round(Math.sqrt(Math.pow(m-h.top,2)+Math.pow(n-h.left,2)));return E!==D[0].scrollTop&&(E=D[0].scrollTop),null!==F&&(E=F),d=b-H,e=c-q+E,f=d-o,g=e-p,a.$bloq[0].style.transform="translate("+f+"px,"+g+"px)",i>10&&(m=h.top,n=h.left),"statement-input"===a.bloqData.type&&w.redrawTree(a,A,y),i},aa=function(a,b){var c=b.attr("data-connector-id"),d=$('[data-connector-id="'+c+'"]').attr("data-canconnectwith"),e=w.itsARootConnector(y[c])||w.itsInsideAConnectorRoot(w.getBloqByConnectorUuid(c,A,y),A,y);fa(c,d),e?ba(a,b):ga(c,d)},ba=function(a,b){var c=b.attr("data-connector-id"),d=A[y[c].bloqUuid];if(a.$bloq.addClass("inside-bloq"),a.$bloq.removeAttr("style"),w.itsARootConnector(y[c])){var e=d.$bloq.find(".bloq--extension__content");e.first().append(a.$bloq),d.$bloq.addClass("with--content")}else d.$bloq.after(a.$bloq);for(var f,g=y[a.connectors[1]].connectedTo,h=[];g;)f=A[y[g].bloqUuid],h.push(f.$bloq),f.$bloq.addClass("inside-bloq"),f.$bloq.removeAttr("style"),g=y[f.connectors[1]].connectedTo;a.$bloq.after(w.jqueryObjectsArrayToHtmlToInsert(h)),w.redrawTree(d,A,y)},ca=function(a,b){var c=b.attr("data-connector-id"),d=w.getOutputConnector(a,z).uuid;b.append(a.$bloq),a.$bloq.addClass("nested-bloq").removeAttr("style"),z[c].connectedTo=d,z[d].connectedTo=c;var e=w.getBloqByConnectorUuid(c,A,z),f=w.getBloqByConnectorUuid(d,A,z);e.bloqData.returnType&&"fromInput"===e.bloqData.returnType.type&&(f.bloqData.returnType.pointer||ha(e))},da=function(a){var b,c,d,e,f;B.forEach(function(g){for(d=y[g].jqueryObject,b=0,c=!1;!c&&b<a.length;)e=y[a[b]].jqueryObject,y[a[b]].data.type===y[g].data.accept&&w.canConnectAliases(y[g].data.acceptedAliases,y[a[b]].data.acceptedAliases)&&w.itsOver(e,d,20)?c=!0:b++;f=w.getBloqByConnectorUuid(g,A,y),c?(d.addClass("available"),d.attr("data-canconnectwith",a[b]),"group"===f.bloqData.type&&f.$bloq.addClass("bloq--dragging")):("group"===f.bloqData.type&&f.$bloq.removeClass("bloq--dragging"),d.removeClass("available"),d.removeAttr("data-canconnectwith"))})},ea=function(a,b){var c,d=w.getOutputConnector(a,z);b.forEach(function(a){c=z[a],w.itsOver(d.jqueryObject,c.jqueryObject,0)&&w.sameConnectionType(A[d.bloqUuid],A[c.bloqUuid],c.data.acceptType,A,z,G,O)?c.jqueryObject.addClass("available"):c.jqueryObject.removeClass("available")})},fa=function(a,b){if(y[a].connectedTo){var c,d,e,f;switch(y[a].data.type){case"connector--bottom":c=y[a].connectedTo,d=w.getLastBottomConnectorUuid(y[b].bloqUuid,A,y),y[d].connectedTo=c,y[c].connectedTo=d;break;case"connector--top":e=y[a].connectedTo,f=w.getFirstTopConnectorUuid(y[b].bloqUuid,A,y),y[e].connectedTo=f,y[f].connectedTo=e;break;case"connector--root":c=y[a].connectedTo,d=w.getLastBottomConnectorUuid(y[b].bloqUuid,A,y),y[d].connectedTo=c,y[c].connectedTo=d;break;default:throw"connector on setLogicalConnections no handled "+y[a].data.type}}y[a].connectedTo=b,y[b].connectedTo=a},ga=function(a,b){var c=A[y[a].bloqUuid];switch(c.bloqData.type){case"statement":case"statement-input":w.redrawTree(w.getBloqByConnectorUuid(b,A,y),A,y);break;case"output":break;default:throw"bloqtype not defined in nesting "+c.bloqData.type}},ha=function(a,b,c,d){var e=a.bloqData.createDynamicContent;if(!e)throw"We are adding a softVar on a bloq that not defined the dynamic content";if(!G[e])throw"dynamicContentType not defined "+a.bloqData.name;for(var f=!1,g=0;!f&&g<G[e].length;)G[e][g].bloqUuid===a.uuid&&(f=!0),g++;c=c||w.getTypeFromBloq(a,A,z,G,O),d="statement-input"===a.bloqData.type&&a.bloqData.arguments?d||w.getArgsFromBloq(a,A,z):"";var h;f?(h=G[e][g-1],h.name=b||h.name,h.type=c,h.args=d,h.name?$('option[data-var-id="'+h.id+'"]').attr({value:h.name}).html(h.name):ia(a)):b&&(h={name:b,id:w.generateUUID(),bloqUuid:a.uuid,type:c,args:d},G[e].push(h),$('select[data-dropdowncontent="'+e+'"]').append($("<option>").attr({"data-var-id":h.id,value:h.name}).html(h.name))),ja(G,e,A,z)},ia=function(a){for(var b=a.bloqData.createDynamicContent,c=!1,d=0;!c&&d<G[b].length;)G[b][d].bloqUuid===a.uuid&&(c=!0),d++;if(c){var e=G[b][d-1];G[b].splice(d-1,1),$('option[data-var-id="'+e.id+'"]').remove()}ja(G,b,A,z)},ja=function(a,b,c,d){"returnFunctions"===b||"softwareVars"===b?(h(a,"returnFunctions",c,d),h(a,"softwareVars",c,d)):h(a,b,c,d)},ka=function(a,b,c){var d,e=A[a];if(console.log("remove:",a),!e)throw"Cant delete this bloq: "+a;console.log("remove bloq name:",e.bloqData.name);var f,g,h;if(window.dispatchEvent(new Event("bloqs:bloqremoved")),e.$bloq[0].removeEventListener("mousedown",R),e.$bloqInputs)for(d=0;d<e.$bloqInputs.length;d++)e.$bloqInputs[d].off("click");switch((L&&L.getAttribute("data-bloq-id")===a||M&&M.uuid)&&(document.removeEventListener("mouseup",S),document.removeEventListener("mousemove",T),document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",V),document.removeEventListener("touchend",S),document.removeEventListener("touchmove",T),document.removeEventListener("touchmove",U),document.removeEventListener("touchend",V)),e.bloqData.type){case"statement-input":e.$bloq.find(".btn-collapse")[0].removeEventListener("click",l);case"group":for(var i,j=y[e.connectors[2]].connectedTo;j;)i=w.getBloqByConnectorUuid(j,A,y),j=y[i.connectors[1]].connectedTo,ka(i.uuid,b,c);case"statement":f=y[e.connectors[0]].connectedTo,g=y[e.connectors[1]].connectedTo;var k;c?(f&&(y[f].connectedTo=null,"connector--root"===y[f].data.type?(k=A[y[f].bloqUuid],"group"===k.bloqData.type&&k.$bloq.removeClass("with--content"),b&&w.redrawTree(w.getBloqByConnectorUuid(f,A,y),A,y)):ka(y[f].bloqUuid,b,c)),g&&(y[g].connectedTo=null,ka(y[g].bloqUuid,b,c))):f&&g?(y[f].connectedTo=g,y[g].connectedTo=f,b&&w.redrawTree(w.getBloqByConnectorUuid(f,A,y),A,y)):f?(y[f].connectedTo=null,k=A[y[f].bloqUuid],"group"===k.bloqData.type&&k.$bloq.removeClass("with--content"),b&&w.redrawTree(w.getBloqByConnectorUuid(f,A,y),A,y)):g&&(y[g].connectedTo=null);var m;for(d=0;d<e.IOConnectors.length;d++)m=e.IOConnectors[d],"connector--input"===z[m].data.type&&z[m].connectedTo&&ka(z[z[m].connectedTo].bloqUuid,b,c);break;case"output":h=z[e.IOConnectors[0]].connectedTo,h&&(z[h].connectedTo=null);break;default:throw"we dont know how to delete: "+e.bloqData.type}e.$bloq.remove();var n;for(d=0;d<e.connectors.length;d++)delete y[e.connectors[d]];for(d=0;d<e.IOConnectors.length;d++)delete z[e.IOConnectors[d]];if(e.bloqData.createDynamicContent)ia(e);else for(n in G)ja(G,n,A,z);delete A[a]},la=function(a){for(var b,c=a.bloqData,d=0;d<c.content.length;d++)for(var e=0;e<c.content[d].length;e++)b=oa(a,c.content[d][e],G),"DOWN"===c.content[d][e].position?(a.$contentContainerDown.addClass("with-content"),a.$contentContainerDown.append(b)):a.$contentContainer.append(b)},ma=function(a,b,c,d,e){var f=$("<div>").attr({"data-connector-id":a});return f.addClass("connector connector--offline "+b.type),e.append(f),y[a]=d,c.connectors.push(a),f},na=function(a,b){for(var c,d,e,f,g=0;g<a.length;g++){switch(d="connector:"+w.generateUUID(),e={uuid:d,data:a[g],bloqUuid:b.uuid,connectedTo:null},a[g].type){case"connector--top":f="statement-input"===b.bloqData.type?b.$bloq.children(".bloq--statement-input__header"):b.$bloq.children(".bloq--fixed"),c=ma(d,a[g],b,e,f);break;case"connector--bottom":f="statement-input"===b.bloqData.type?b.$bloq.find(".bloq--extension--end"):b.$bloq.children(".bloq--fixed"),c=ma(d,a[g],b,e,f);break;case"connector--root":f="statement-input"===b.bloqData.type?b.$bloq.children(".bloq--statement-input__header"):b.$bloq,c=ma(d,a[g],b,e,f);break;case"connector--input":c=$(b.$bloq.find('.bloqinput[data-connector-name="'+a[g].name+'"]')),c.attr({"data-connector-id":d}).addClass("connector "+a[g].type),e.contentId=c.attr("data-content-id"),z[d]=e,b.IOConnectors.push(d);break;case"connector--output":c=$("<div>").attr({"data-connector-id":d}).addClass("connector connector--offline "+a[g].type),b.$bloq.append(c),e.returnType=b.bloqData.returnType,z[d]=e,b.IOConnectors.push(d);break;case"connector--empty":c=$("<div>"),y[d]=e,b.connectors.push(d);break;default:throw"Connector not defined to build"}e.jqueryObject=c}},oa=function(a,b,d){var e,f,g,h,k=null;switch(b.alias){case"staticDropdown":k=$("<select>"),k.attr({name:"","data-content-id":b.id});var l=[];for(e=0;e<b.options.length;e++)f=$("<option>").attr({value:b.options[e].value,"data-i18n":b.options[e].label}).html(wa(x,b.options[e].label)),l.push(f);w.appendArrayInOneTime(k,l),b.value&&k.val(b.value),k.change(function(){window.dispatchEvent(new Event("bloqs:change"))}),a.bloqData.returnType&&"fromDropdown"===a.bloqData.returnType.type&&k.change(function(){ha(a)});break;case"dynamicDropdown":switch(k=$("<select>"),k.attr({name:"","data-content-id":b.id,"data-dropdowncontent":b.options,"data-value":b.value}),b.options){case"voidFunctions":case"returnFunctions":case"softwareVars":case"classes":case"objects":g=d[b.options],k.change(function(){if("output"===a.bloqData.type){var b=w.getOutputConnector(a,z);if(b.connectedTo){var c=z[b.connectedTo],d=A[c.bloqUuid];d.bloqData.returnType&&"fromInput"===d.bloqData.returnType.type&&ha(d)}}});break;case"allServos":g=[],g=g.concat(O.servos,O.oscillators,O.continuousServos);break;case"sensors":g=[],g=g.concat(O.sensors,O.mkb_lightsensor,O.mkb_linefollower,O.mkb_soundsensor,O.joystick,O.mkb_4buttonKeyPad,O.remoteControl,O.mkb_motionSensor);break;case"varComponents":g=[];for(h in O)O[h].length>=1&&(g=g.concat(O[h]));break;case"clocks":g=[],g=O.clocks;break;case"hts221":g=[],g=O.hts221;break;case"barometer":g=[],g=O.barometer;default:g=O[b.options]}if(!g)throw"Dropdowns not defined in array: "+b.options;if(w.drawDropdownOptions(k,g),b.value){k.val(b.value);
var m=g.find(function(a){return a.name===b.value});k[0].dataset.reference=m?m.uid:"",k[0].dataset.value=b.value,k.val(b.value)}k.change(function(a){k[0].dataset.value=a.currentTarget.value,k[0].dataset.reference=a.currentTarget.selectedOptions[0].dataset.reference,window.dispatchEvent(new Event("bloqs:change"))});break;case"text":k=$("<span>").attr({"data-i18n":b.value}).html(wa(x,b.value));break;case"removableText":k=$("<span>").html(b.value),k.addClass("removabletext");break;case"numberInput":k=$("<input>").attr({type:"text","data-content-id":b.id,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value),k.bind("input",function(){var a=w.getCaretPosition(this),b=w.validNumber($(this).val());$(this).val(b.value),w.setCaretPosition(this,a-b.removedChar)}),k.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:60,comfortZone:30})}),k.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"stringInput":k=$("<input>").attr({type:"text","data-content-id":b.id,"data-content-type":b.alias,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value||wa(x,b.defaultValue)),k.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),k.change(function(){k.val(w.validString(k.val())),window.dispatchEvent(new Event("bloqs:change"))});break;case"charInput":k=$("<input>").attr({type:"text","data-content-id":b.id,"data-content-type":b.alias,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value),k.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),k.change(function(){k.val(w.validChar(k.val())),window.dispatchEvent(new Event("bloqs:change"))});break;case"codeInput":k=$("<input>").attr({type:"text","data-content-id":b.id,"data-content-type":b.alias,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value),k.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),k.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"multilineCodeInput":k=$('<textarea class="msd-elastic: \n;" ng-model="bar" cols="40" rows="1"></textarea>').attr({"data-content-id":b.id,"data-content-type":b.alias,name:b.id,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value),setTimeout(function(){$('[name="'+b.id+'"]').autogrow({onInitialize:!0})},0),k.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"multilineCommentInput":k=$('<textarea class="msd-elastic: \n;" ng-model="bar" cols="40" rows="1"></textarea>').attr({"data-content-id":b.id,"data-content-type":b.alias,name:b.id,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value),setTimeout(function(){$('[name="'+b.id+'"]').autogrow({onInitialize:!0})},0),k.keyup(function(){c.delay(function(){k.val(w.validComment(k.val()))},1e3)}),k.change(function(){k.val(w.validComment(k.val())),window.dispatchEvent(new Event("bloqs:change"))});break;case"varInput":k=$("<input>").attr({type:"text","data-content-id":b.id,"data-placeholder-i18n":b.placeholder,placeholder:wa(x,b.placeholder)}).val(b.value),a.varInputs=[],a.varInputs.push(k),k.addClass("var--input"),k.on("keyup",function(a){$(a.currentTarget).autoGrowInput({minWidth:100,comfortZone:30})}),k.keyup(function(){console.log(a),c.delay(function(){var b=w.validName(k.val(),a.uuid,d);k.val(b),b?ha(a,b):ia(a,b)},1e3,a.uuid)}),k.change(function(){window.dispatchEvent(new Event("bloqs:change"))});break;case"bloqInput":k=$("<div>").attr({"data-connector-name":b.name,"data-content-id":b.bloqInputId}),k.addClass("bloqinput"),k.click(j),a.$bloqInputs||(a.$bloqInputs=[]),a.$bloqInputs.push(k);break;case"headerText":k=$("<h3>").html(b.value),k.addClass("headerText");break;case"descriptionText":k=$("<p>").html(b.value),k.addClass("descriptionText");break;case"dotsMatrix":k=$('<div class="bloqs-dotsMatrix">'),k.click(function(a){i(b,a)});break;default:throw"elementSchema not defined: "+b.alias}return k},pa=function(a){if(a!==x){x=a;var b,c,d;for(var e in A){c=A[e].$bloq.find("[data-placeholder-i18n]"),b=A[e].$bloq.find("[data-i18n]");for(var g=0;g<c.length;g++)d=c[g].getAttribute("data-placeholder-i18n"),c[g].placeholder=wa(x,d);for(var h=0;h<b.length;h++)d=b[h].getAttribute("data-i18n"),b[h].innerHTML=wa(x,d)}f.setSuggestedText(wa(x,"suggested"))}},qa=function(){var a,b;for(a in A)if(b=A[a],b.isConnectable())switch(b.bloqData.type){case"statement":case"statement-input":y[b.connectors[0]].connectedTo||ka(a);break;case"output":z[b.IOConnectors[0]].connectedTo||ka(a);break;case"group":break;default:throw"its free? "+b.bloqData.type}},ra=function(){var a,b,c,d,e=[];for(var f in A)if(a=A[f],a.isConnectable())switch(a.bloqData.type){case"statement":case"statement-input":if(!y[a.connectors[0]].connectedTo){for(b=[a.getBloqsStructure()],d=y[a.connectors[1]].connectedTo;d;)c=w.getBloqByConnectorUuid(d,A,y),b.push(c.getBloqsStructure()),d=y[c.connectors[1]].connectedTo;e.push({position:a.$bloq.position(),bloqGroup:b})}break;case"output":z[a.IOConnectors[0]].connectedTo||(b=[a.getBloqsStructure()],e.push({position:a.$bloq[0].getBoundingClientRect(),bloqGroup:b}));break;case"group":break;default:throw"its free? "+a.bloqData.type}return e},sa=function(a){O=a,v||(v=setTimeout(function(){v=null,ta(O)},200))},ta=function(b){function d(a,b){b[0]?(a.dataset.reference=b[0].uid,a.dataset.value=b[0].name,a.value=b[0].name):(delete a.dataset.reference,delete a.dataset.value),a.selectedIndex=0}var e,f=(a.bloqs,[]),g=function(a,b){var e=b.find(function(b){return b.uid===a.dataset.reference});c.drawDropdownOptions($(a),b),e?(a.value=e.name,a.dataset.reference=e.uid,a.dataset.value=e.name):d(a,b)},h=null;for(var i in b){h=document.getElementsByClassName("bloqs-tab")[0];var j=h.querySelectorAll('select[data-dropdowncontent="'+i+'"]');e="sensors"===i?b.sensors.concat(b.mkb_lightsensor,b.mkb_linefollower,b.mkb_soundsensor,b.joystick,b.mkb_4buttonKeyPad,b.remoteControl,b.mkb_motionSensor):b[i];for(var k=0,l=j.length;k<l;k++)g(j[k],e);f=f.concat(b[i])}if(h){for(var m=h.querySelectorAll('select[data-dropdowncontent="varComponents"]'),n=0,o=m.length;n<o;n++)g(m[n],f);var p=[];p=p.concat(b.servos,b.oscillators,b.continuousServos);for(var q=h.querySelectorAll('select[data-dropdowncontent="allServos"]'),r=0,s=q.length;r<s;r++)g(q[r],p)}},ua=function(){var a;for(a in G)va(a)},va=function(a){var b,d;$('select[data-dropdownContent="'+a+'"]').each(function(e,f){b=$(f),d=b.attr("data-value"),c.drawDropdownOptions(b,G[a]),d&&b.val(d)})},wa=function(a,b){return d.texts[a]||(console.error("Language not supported "+a),a="en-GB"),d.texts[a][b]||d.texts["en-GB"][b]||d.texts["es-ES"][b]||b},xa=function(a){if(a.bloqData){this.uuid="bloq:"+w.generateUUID(),a.$field&&!a.$field.is(D)&&(D=a.$field,e.addBloqsTooltip(D)),this.bloqData=b.cloneDeep(a.bloqData),O=a.componentsArray||O,this.connectors=[],this.IOConnectors=[];var c,d=!1,f=this;switch(this.collapseGroupContent=function(){var a=f.$bloq.children(".field--content");a.toggleClass("field--collapsed"),f.connectable=!f.connectable,a.parent().toggleClass("collapsed--field")},this.enable=function(a){if(!d){if(this.$bloq.removeClass("disabled"),this.bloqData.content&&this.bloqData.content[0])for(var b=0;b<this.bloqData.content[0].length;b++)if("bloqInput"===this.bloqData.content[0][b].alias)for(var c,e=0;e<this.IOConnectors.length;e++)c=this.IOConnectors[e],"connector--input"===z[c].data.type&&z[c].connectedTo&&w.getBloqByConnectorUuid(z[c].connectedTo,A,z).enable();if(d=!0,this.connectors[2]&&!a)for(var f,g=y[this.connectors[2]].connectedTo;g;)f=w.getBloqByConnectorUuid(g,A,y),f.enable(),g=y[f.connectors[1]].connectedTo}},this.disable=function(a){if(this.$bloq.addClass("disabled"),d){if(this.bloqData.content&&this.bloqData.content[0])for(var b=0;b<this.bloqData.content[0].length;b++)switch(this.bloqData.content[0][b].alias){case"bloqInput":for(var c,e=0;e<this.IOConnectors.length;e++)c=this.IOConnectors[e],"connector--input"===z[c].data.type&&z[c].connectedTo&&w.getBloqByConnectorUuid(z[c].connectedTo,A,z).disable()}if(d=!1,this.connectors[2]&&!a)for(var f,g=y[this.connectors[2]].connectedTo;g;)f=w.getBloqByConnectorUuid(g,A,y),f.disable(),g=y[f.connectors[1]].connectedTo}},this.itsEnabled=function(){return d},this.doConnectable=function(){if(!c){if(this.bloqData.content&&this.bloqData.content[0])for(var a=0;a<this.bloqData.content[0].length;a++)if("bloqInput"===this.bloqData.content[0][a].alias)for(var b,d=0;d<this.IOConnectors.length;d++)b=this.IOConnectors[d],"connector--input"===z[b].data.type&&z[b].connectedTo&&w.getBloqByConnectorUuid(z[b].connectedTo,A,z).doConnectable();if(this.connectors[2])for(var e,f=y[this.connectors[2]].connectedTo;f;)e=w.getBloqByConnectorUuid(f,A,y),e.doConnectable(),f=y[e.connectors[1]].connectedTo;c=!0,this.$bloq[0].dispatchEvent(new Event("bloq:connectable"))}},this.doNotConnectable=function(){c=!1},this.isConnectable=function(){return c},this.itsFree=function(){return 0===this.$bloq.closest(".bloq--group").length},this.autoRemove=function(){ka(this.uuid)},this.$bloq=$("<div>").attr({"data-bloq-id":this.uuid,tabIndex:0}),this.$bloq.addClass("bloq bloq--"+this.bloqData.type+" "+this.bloqData.bloqClass),A[this.uuid]=this,this.doNotConnectable(),this.bloqData.type){case"statement-input":this.$bloq.append('<div class="bloq--statement-input__header"><button class="btn-collapse">-</button></div><div class="bloq--extension"><div class="bloq--extension__content"></div> <div class="bloq--extension--end"></div></div>'),this.$contentContainer=this.$bloq.find(".bloq--statement-input__header"),this.$contentContainerDown=this.$bloq.find(".bloq--extension--end"),la(this),this.$bloq[0].addEventListener("mousedown",R),this.$bloq[0].addEventListener("touchstart",R),this.$bloq.find(".btn-collapse")[0].addEventListener("click",l),na(a.bloqData.connectors,this),this.$contentContainer.children().children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$contentContainer.children().children().not(".connector.connector--offline").last().addClass("bloq__inner--last"),this.$contentContainer.children().not(".connector.connector--offline").last().addClass("bloq__inner--last"),this.$contentContainerDown.children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$contentContainerDown.children().not(".connector.connector--offline").last().addClass("bloq__inner--last");break;case"statement":this.$bloq.append('<div class="bloq--fixed">'),this.$contentContainer=this.$bloq.find(".bloq--fixed"),la(this),this.$bloq[0].addEventListener("mousedown",R),this.$bloq[0].addEventListener("touchstart",R),na(a.bloqData.connectors,this),this.$bloq.children().children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$bloq.children().children().not(".connector.connector--offline").last().addClass("bloq__inner--last");break;case"output":this.$contentContainer=this.$bloq,la(this),this.$bloq[0].addEventListener("mousedown",R),this.$bloq[0].addEventListener("touchstart",R),na(a.bloqData.connectors,this),this.$bloq.children().not(".connector.connector--offline").first().addClass("bloq__inner--first"),this.$bloq.children().not(".connector.connector--offline").last().addClass("bloq__inner--last");break;case"group":this.$bloq.append('<div class="field--header"><button class="btn btn--collapsefield"></button><h3 data-i18n="'+this.bloqData.headerText+'">'+wa(x,this.bloqData.headerText)+'</h3></div><div class="field--content"><div class="bloq--extension--info"> <div class="bloq__info"><p class="bloq__info--text" data-i18n="'+this.bloqData.descriptionText+'">'+wa(x,this.bloqData.descriptionText)+'</p></div><p class="bloq--drag-bloq" data-i18n="drag-bloq">'+wa(x,"drag-bloq")+'</p></div><div class="bloq--extension__content"></div></div>'),na(a.bloqData.connectors,this),this.$bloq.find(".connector--root").addClass("connector--root--group"),this.$bloq.find(".field--header .btn").on("click",this.collapseGroupContent),this.$bloq.find(".field--header h3").on("click",this.collapseGroupContent);break;default:throw"bloqData "+this.bloqData.type+"not defined in bloq construction"}if(this.bloqData.createDynamicContent){var g=w.validName(this.$bloq.find("input.var--input").val(),this.uuid);g?ha(this,g):ia(this,g)}return this.getIOConnectorUuidByContentId=function(a){for(var b=!1,c=0,d=null;!b&&c<this.IOConnectors.length;)z[this.IOConnectors[c]].contentId===a&&(b=!0,d=this.IOConnectors[c]),c++;return d},this.getBloqsStructure=function(a){var c,d;c=a?b.cloneDeep(this.bloqData):{name:this.bloqData.name,content:[[]]},c.enable=this.itsEnabled();var e=this.connectors[2];if(e){c.childs=[];for(var f=y[e].connectedTo;f;)d=w.getBloqByConnectorUuid(f,A,y),c.childs.push(d.getBloqsStructure(a)),f=y[d.connectors[1]].connectedTo}var g,h,i,j;if(this.bloqData.content[0])for(var k=0;k<this.bloqData.content[0].length;k++){switch(g=null,this.bloqData.content[0][k].alias){case"varInput":case"stringInput":case"numberInput":case"multilineCodeInput":case"multilineCommentInput":case"codeInput":case"charInput":h=this.$bloq.find('[data-content-id="'+this.bloqData.content[0][k].id+'"]').val(),h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h});break;case"bloqInput":var l,m;l=this.getIOConnectorUuidByContentId(this.bloqData.content[0][k].bloqInputId),"connector--input"===z[l].data.type&&z[l].connectedTo&&(m=w.getBloqByConnectorUuid(z[l].connectedTo,A,z),g={alias:this.bloqData.content[0][k].alias,bloqInputId:this.bloqData.content[0][k].bloqInputId,value:m.getBloqsStructure(a)});break;case"dynamicDropdown":j=this.$bloq.find('select[data-content-id="'+this.bloqData.content[0][k].id+'"][data-dropdowncontent="'+this.bloqData.content[0][k].options+'"]').attr("data-value"),i=this.$bloq.find('select[data-content-id="'+this.bloqData.content[0][k].id+'"][data-dropdowncontent="'+this.bloqData.content[0][k].options+'"]').val();var n,o,p=this.bloqData.content[0][k].options,q=Object.keys(G).indexOf(p),r=O.sensors.concat(O.mkb_lightsensor,O.mkb_linefollower,O.mkb_soundsensor,O.joystick,O.mkb_4buttonKeyPad,O.remoteControl,O.mkb_motionSensor);if(q!==-1)for(h=i,o=0;!n&&o<G[p].length;)G[p][o].name===h&&(n=G[p][o].type||-1),o++;else if("sensors"===p)for(h=i,o=0;!n&&o<r.length;)r[o].name===h&&(n=r[o].dataReturnType),o++;else h=j||i;h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h,valueType:n});break;case"staticDropdown":h=this.$contentContainer.find('> select[data-content-id="'+this.bloqData.content[0][k].id+'"]').val(),h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h});break;case"text":break;case"dotsMatrix":h=this.bloqData.content[0][k].value,h&&(g={alias:this.bloqData.content[0][k].alias,id:this.bloqData.content[0][k].id,value:h});break;default:throw"I dont know how to get the structure from this contentType :( "+this.bloqData.content[0][k].alias}g&&(a?(c.content[0][k].value=g.value,c.content[0][k].valueType=g.valueType):c.content[0].push(g))}return c},window.dispatchEvent(new CustomEvent("bloqs:created",{detail:{bloq:this}})),this}console.error("the bloqData its empty.")},ya=function(){G={voidFunctions:[],returnFunctions:[],softwareVars:[],classes:[],objects:[]}},za=function(a,d,e,f){var g,h,i,j,k,l,m,n,o=b.cloneDeep(e[a.name]);if(o||console.error("no original schema",a),h=c.fillSchemaWithContent(o,a),g=new xa({bloqData:h,componentsArray:d,$field:f}),a.content)for(n=0;n<a.content[0].length;n++)"bloqInput"===a.content[0][n].alias&&(l=g.getIOConnectorUuidByContentId(a.content[0][n].bloqInputId),m=g.$bloq.find('[data-connector-id="'+l+'"]').first(),k=za(a.content[0][n].value,d,e,f),k.$bloq.addClass("nested-bloq"),z[l]||console.debug("not connector?",o),z[l].connectedTo=k.IOConnectors[0],z[k.IOConnectors[0]].connectedTo=l,m.append(k.$bloq));if(a.childs)for(m=g.$bloq.find(".bloq--extension__content"),i=g.connectors[2],a.childs.length>0&&g.$bloq.addClass("with--content"),n=0;n<a.childs.length;n++)j=za(a.childs[n],d,e,f),y[i].connectedTo=j.connectors[0],y[j.connectors[0]].connectedTo=i,i=j.connectors[1],j.$bloq.addClass("inside-bloq"),m.append(j.$bloq);return a.enable?g.enable(!0):g.disable(),g.bloqData.createDynamicContent&&ha(g),g};return a.Bloq=xa,a.updateSoftVar=ha,a.connectors=y,a.IOConnectors=z,a.bloqs=A,a.removeBloq=ka,a.translateBloqs=pa,a.getFreeBloqs=ra,a.destroyFreeBloqs=qa,a.updateDropdowns=ua,a.setOptions=P,a.buildBloqWithContent=za,a.clearSoftwareArrays=ya,a.startBloqsUpdate=sa,a}(window.bloqs=window.bloqs||{},_,bloqsUtils,bloqsLanguages,bloqsTooltip,bloqsSuggested,bloqsDotsMatrix,void 0);