...
/**
* Bloq name: oscillatorTimesPhase
* 
* Bloq type: Statement
*
...
var oscillatorTimesPhase = _.merge(_.clone(StatementBloq, true), {
...
utils.generateBloqInputConnectors(oscillatorTimesPhase);

module.exports = oscillatorTimesPhase;