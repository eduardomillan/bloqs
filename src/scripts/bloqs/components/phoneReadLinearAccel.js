...
var phoneReadLinearAccel = _.merge(_.clone(OutputBloq, true), {
    ...
    arduino: {
        ...
        extraFunctionCode: 'String getAcceleration(axis,phone){phone.println(String("readLAccel-")+String(axis));String data="";while(data==""){data=phone.readString();}return data;}}',
